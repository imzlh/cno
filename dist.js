...
// src/webapi/basic.ts
var basic_exports = {};
var crypto, engine2, text, os2, fs2, timer;
var init_basic = __esm({
  "src/webapi/basic.ts"() {
    "use strict";
    init_assert();
    crypto = import.meta.use("crypto");
    engine2 = import.meta.use("engine");
    text = import.meta.use("text");
    os2 = import.meta.use("os");
    fs2 = import.meta.use("fs");
    timer = import.meta.use("timers");
    assert(text, "text module is not available");
    globalThis.atob = function(str) {
      const dec = crypto.base64Decode(str);
      return engine2.decodeString(dec);
    };
    globalThis.btoa = function(str) {
      const enc = engine2.encodeString(str);
    ...
    globalThis.prompt = function(msg) {
      fs2.setBlocking(os2.STDIN_FILENO, true);
      fs2.setBlocking(os2.STDOUT_FILENO, true);
      assert(fs2.write(os2.STDOUT_FILENO, engine2.encodeString(msg ? msg + " " : "? ")), "write() operation failed");
      let buf = new Uint8Array(1024);
      let i2 = 0;
      const LF = engine2.encodeString("\n")[0];
      while (true) {
        const n2 = fs2.read(os2.STDIN_FILENO, buf);
        if (n2 === 0) break;
        for (let j3 = 0; j3 < n2; j3++) {
          if (buf[j3] === LF) {
            const s2 = engine2.decodeString(buf.subarray(0, j3));
            fs2.setBlocking(os2.STDIN_FILENO, false);
            fs2.setBlocking(os2.STDOUT_FILENO, false);
            return s2;
          }
        }
        if (i2 + n2 > buf.length) {
...
var require_lib = __commonJS({
  "node_modules/.pnpm/webidl-conversions@8.0.0/node_modules/webidl-conversions/lib/index.js"(exports) {
    ...
    exports.ByteString = (value, options = {}) => {
      ...
      let c2;
      for (let i2 = 0; (c2 = x3.codePointAt(i2)) !== void 0; ++i2) {
        if (c2 > 255) {
...
var require_url_state_machine = __commonJS({
  "node_modules/.pnpm/whatwg-url@15.1.0/node_modules/whatwg-url/lib/url-state-machine.js"(exports, module) {
    ...
    URLStateMachine.prototype["parse authority"] = function parseAuthority(c2, cStr) {
      if (c2 === p2("@")) {
        ...
        for (let pointer = 0; pointer < len; ++pointer) {
          ...
          if (codePoint === p2(":") && !this.passwordTokenSeen) {
    ...
    URLStateMachine.prototype["parse hostname"] = URLStateMachine.prototype["parse host"] = function parseHostName(c2, cStr) {
      ...
      } else if (c2 === p2(":") && !this.insideBrackets) {
        if (this.buffer === "") {
          this.parseError = true;
          return failure;
        }
...
var require_urlencoded = __commonJS({
  "node_modules/.pnpm/whatwg-url@15.1.0/node_modules/whatwg-url/lib/urlencoded.js"(exports, module) {
    ...
    function replaceByteInByteSequence(buf, from, to2) {
...
var require_URLSearchParams = __commonJS({
  "node_modules/.pnpm/whatwg-url@15.1.0/node_modules/whatwg-url/lib/URLSearchParams.js"(exports) {
    ...
    exports.install = (globalObject, globalNames) => {
      ...
      Object.defineProperties(URLSearchParams3.prototype, {
        ...
        [Symbol.iterator]: { value: URLSearchParams3.prototype.entries, configurable: true, writable: true }
      });
      ctorRegistry[interfaceName] = URLSearchParams3;
...
var require_URL_impl = __commonJS({
  "node_modules/.pnpm/whatwg-url@15.1.0/node_modules/whatwg-url/lib/URL-impl.js"(exports) {
    ...
    var urlencoded = require_urlencoded();
    var URLSearchParams3 = require_URLSearchParams();
    exports.implementation = class URLImpl {
      ...
      constructor(globalObject, [url, base]) {
        ...
        this._url = parsedURL;
        this._query = URLSearchParams3.createImpl(globalObject, [query], { doNotStripQMark: true });
    ...
    exports.install = (globalObject, globalNames) => {
      ...
      class URL3 {
        ...
        set protocol(V3) {
          ...
          esValue[implSymbol]["protocol"] = V3;
        }
        get username() {
          const esValue = this !== null && this !== void 0 ? this : globalObject;
          if (!exports.is(esValue)) {
        ...
        set username(V3) {
          ...
          esValue[implSymbol]["username"] = V3;
        }
        get password() {
          const esValue = this !== null && this !== void 0 ? this : globalObject;
          if (!exports.is(esValue)) {
        ...
        set password(V3) {
          ...
          esValue[implSymbol]["password"] = V3;
        }
        get host() {
          const esValue = this !== null && this !== void 0 ? this : globalObject;
          if (!exports.is(esValue)) {
        ...
        set hostname(V3) {
          ...
          esValue[implSymbol]["hostname"] = V3;
        }
        get port() {
          const esValue = this !== null && this !== void 0 ? this : globalObject;
          if (!exports.is(esValue)) {
        ...
        set pathname(V3) {
          ...
          esValue[implSymbol]["pathname"] = V3;
        }
        get search() {
          const esValue = this !== null && this !== void 0 ? this : globalObject;
          if (!exports.is(esValue)) {
...
var require_webidl2js_wrapper = __commonJS({
  "node_modules/.pnpm/whatwg-url@15.1.0/node_modules/whatwg-url/webidl2js-wrapper.js"(exports) {
    ...
    var URLSearchParams3 = require_URLSearchParams();
    exports.URL = URL3;
    exports.URLSearchParams = URLSearchParams3;
  }
});
...
var require_whatwg_url = __commonJS({
  "node_modules/.pnpm/whatwg-url@15.1.0/node_modules/whatwg-url/index.js"(exports) {
    "use strict";
    var { URL: URL3, URLSearchParams: URLSearchParams3 } = require_webidl2js_wrapper();
    ...
    URLSearchParams3.install(sharedGlobalObject, ["Window"]);
...
function D(e2, t2 = false) {
  let r2 = [], n2 = 0;
  for (; n2 < e2.length; ) {
    let c2 = e2[n2], l2 = a(function(f2) {
      if (!t2) throw new TypeError(f2);
    ...
    if (c2 === ":") {
      let f2 = "", s2 = n2 + 1;
      for (; s2 < e2.length; ) {
        let i2 = e2.substr(s2, 1);
        if (s2 === n2 + 1 && Re.test(i2) || s2 !== n2 + 1 && Ee.test(i2)) {
          f2 += e2[s2++];
          continue;
        }
        break;
      ...
      if (!f2) {
        l2(`Missing parameter name at ${n2}`);
        continue;
      }
      r2.push({ type: "NAME", index: n2, value: f2 }), n2 = s2;
      continue;
    }
    if (c2 === "(") {
      let f2 = 1, s2 = "", i2 = n2 + 1, o2 = false;
      if (e2[i2] === "?") {
        l2(`Pattern cannot start with "?" at ${i2}`);
        continue;
      }
      for (; i2 < e2.length; ) {
        if (!Oe(e2[i2], false)) {
          l2(`Invalid character '${e2[i2]}' at ${i2}.`), o2 = true;
          break;
        }
        if (e2[i2] === "\\") {
          s2 += e2[i2++] + e2[i2++];
        ...
        } else if (e2[i2] === "(" && (f2++, e2[i2 + 1] !== "?")) {
          l2(`Capturing groups are not allowed at ${i2}`), o2 = true;
          break;
        }
        s2 += e2[i2++];
      }
      if (o2) continue;
      if (f2) {
        l2(`Unbalanced pattern at ${n2}`);
        continue;
      }
      if (!s2) {
        l2(`Missing pattern at ${n2}`);
        continue;
      }
      r2.push({ type: "REGEX", index: n2, value: s2 }), n2 = i2;
      continue;
    }
...
function F(e2, t2 = {}) {
  ...
  let n2 = `[^${x(t2.delimiter)}]+?`, c2 = [], l2 = 0, f2 = 0, s2 = "", i2 = /* @__PURE__ */ new Set(), o2 = a((u2) => {
    if (f2 < r2.length && r2[f2].type === u2) return r2[f2++].value;
  }, "tryConsume"), h2 = a(() => o2("OTHER_MODIFIER") ?? o2("ASTERISK"), "tryConsumeModifier"), p2 = a((u2) => {
    let d2 = o2(u2);
    if (d2 !== void 0) return d2;
    let { type: g2, index: y2 } = r2[f2];
    throw new TypeError(`Unexpected ${g2} at ${y2}, expected ${u2}`);
  }, "mustConsume"), A2 = a(() => {
    let u2 = "", d2;
    for (; d2 = o2("CHAR") ?? o2("ESCAPED_CHAR"); ) u2 += d2;
    return u2;
  }, "consumeText"), xe2 = a((u2) => u2, "DefaultEncodePart"), N2 = t2.encodePart || xe2, H2 = "", $2 = a((u2) => {
    H2 += u2;
  }, "appendToPendingFixedValue"), M2 = a(() => {
    H2.length && (c2.push(new P(3, "", "", N2(H2), "", 3)), H2 = "");
  }, "maybeAddPartFromPendingFixedValue"), X2 = a((u2, d2, g2, y2, Z2) => {
    let m2 = 3;
    switch (Z2) {
      case "?":
        m2 = 1;
    ...
    if (M2(), !d2 && !g2) {
      if (!u2) return;
      c2.push(new P(3, "", "", N2(u2), "", m2));
      return;
    }
    let S2;
    g2 ? g2 === "*" ? S2 = v : S2 = g2 : S2 = n2;
    let k2 = 2;
    S2 === n2 ? (k2 = 1, S2 = "") : S2 === v && (k2 = 0, S2 = "");
    let E2;
    if (d2 ? E2 = d2 : g2 && (E2 = l2++), i2.has(E2)) throw new TypeError(`Duplicate name '${E2}'.`);
    i2.add(E2), c2.push(new P(k2, E2, N2(u2), S2, N2(y2), m2));
  }, "addPart");
  for (; f2 < r2.length; ) {
    let u2 = o2("CHAR"), d2 = o2("NAME"), g2 = o2("REGEX");
    if (!d2 && !g2 && (g2 = o2("ASTERISK")), d2 || g2) {
      let m2 = u2 ?? "";
      t2.prefixes.indexOf(m2) === -1 && ($2(m2), m2 = ""), M2();
      let S2 = h2();
      X2(m2, d2, g2, "", S2);
      continue;
    }
    let y2 = u2 ?? o2("ESCAPED_CHAR");
    if (y2) {
      $2(y2);
      continue;
    }
    if (o2("OPEN")) {
      let m2 = A2(), S2 = o2("NAME"), k2 = o2("REGEX");
      !S2 && !k2 && (k2 = o2("ASTERISK"));
      let E2 = A2();
      p2("CLOSE");
      let be2 = h2();
      X2(m2, S2, k2, E2, be2);
...
function W(e2, t2, r2 = {}) {
  ...
  for (let s2 of e2) {
    if (s2.type === 3) {
      s2.modifier === 3 ? n2 += x(s2.value) : n2 += `(?:${x(s2.value)})${T(s2.modifier)}`;
      continue;
    }
    t2 && t2.push(s2.name);
    let i2 = `[^${x(r2.delimiter)}]+?`, o2 = s2.value;
    if (s2.type === 1 ? o2 = i2 : s2.type === 0 && (o2 = v), !s2.prefix.length && !s2.suffix.length) {
      s2.modifier === 3 || s2.modifier === 1 ? n2 += `(${o2})${T(s2.modifier)}` : n2 += `((?:${o2})${T(s2.modifier)})`;
      continue;
    }
    if (s2.modifier === 3 || s2.modifier === 1) {
      n2 += `(?:${x(s2.prefix)}(${o2})${x(s2.suffix)})`, n2 += T(s2.modifier);
      continue;
    }
    n2 += `(?:${x(s2.prefix)}`, n2 += `((?:${o2})(?:`, n2 += x(s2.suffix), n2 += x(s2.prefix), n2 += `(?:${o2}))*)${x(s2.suffix)})`, s2.modifier === 0 && (n2 += "?");
  }
  let c2 = `[${x(r2.endsWith)}]|$`, l2 = `[${x(r2.delimiter)}]`;
  if (r2.end) return r2.strict || (n2 += `${l2}?`), r2.endsWith.length ? n2 += `(?=${c2})` : n2 += "$", new RegExp(n2, B(r2));
  r2.strict || (n2 += `(?:${l2}(?=${c2}))?`);
  let f2 = false;
  if (e2.length) {
    let s2 = e2[e2.length - 1];
    s2.type === 3 && s2.modifier === 3 && (f2 = r2.delimiter.indexOf(s2) > -1);
  }
  return f2 || (n2 += `(?=${l2}|${c2})`), new RegExp(n2, B(r2));
}
function ee(e2, t2) {
...
function U(e2) {
  if (!e2) return true;
  for (let t2 of re) if (e2.test(t2)) return true;
  return false;
}
function ne(e2, t2) {
  if (e2 = te(e2, "#"), t2 || e2 === "") return e2;
...
function ce(e2, t2, r2) {
  if (r2 || e2 === "") return e2;
  if (t2 && !re.includes(t2)) return new URL(`${t2}:${e2}`).pathname;
  let n2 = e2[0] == "/";
  return e2 = new URL(n2 ? e2 : "/-" + e2, "https://example.com").pathname, n2 || (e2 = e2.substring(2, e2.length)), e2;
}
function le(e2, t2, r2) {
  return z(t2) === e2 && (e2 = ""), r2 || e2 === "" ? e2 : G(e2);
}
function fe(e2, t2) {
  return e2 = ke(e2, ":"), t2 || e2 === "" ? e2 : w(e2);
}
function z(e2) {
  switch (e2) {
    case "ws":
...
function w(e2) {
  if (e2 === "") return e2;
  if (/^[-+.A-Za-z0-9]*$/.test(e2)) return e2.toLowerCase();
...
function j(e2) {
  if (e2 === "") return e2;
  if (/[\t\n\r #%/:<>?@[\]^\\|]/g.test(e2)) throw new TypeError(`Invalid hostname '${e2}'`);
  let t2 = new URL("https://example.com");
  return t2.hostname = e2, t2.hostname;
}
function K(e2) {
  if (e2 === "") return e2;
  if (/[^0-9a-fA-F[\]:]/g.test(e2)) throw new TypeError(`Invalid IPv6 hostname '${e2}'`);
  return e2.toLowerCase();
}
function G(e2) {
  if (e2 === "" || /^[0-9]*$/.test(e2) && parseInt(e2) <= 65535) return e2;
...
function Se(e2, t2) {
  if (typeof e2 != "string") throw new TypeError("parameter 1 is not of type 'string'.");
  let r2 = new URL(e2, t2);
  return { protocol: r2.protocol.substring(0, r2.protocol.length - 1), username: r2.username, password: r2.password, hostname: r2.hostname, port: r2.port, pathname: r2.pathname, search: r2.search !== "" ? r2.search.substring(1, r2.search.length) : void 0, hash: r2.hash !== "" ? r2.hash.substring(1, r2.hash.length) : void 0 };
}
function R(e2, t2) {
  return t2 ? I(e2) : e2;
}
function L(e2, t2, r2) {
  let n2;
  if (typeof t2.baseURL == "string") try {
    n2 = new URL(t2.baseURL), t2.protocol === void 0 && (e2.protocol = R(n2.protocol.substring(0, n2.protocol.length - 1), r2)), !r2 && t2.protocol === void 0 && t2.hostname === void 0 && t2.port === void 0 && t2.username === void 0 && (e2.username = R(n2.username, r2)), !r2 && t2.protocol === void 0 && t2.hostname === void 0 && t2.port === void 0 && t2.username === void 0 && t2.password === void 0 && (e2.password = R(n2.password, r2)), t2.protocol === void 0 && t2.hostname === void 0 && (e2.hostname = R(n2.hostname, r2)), t2.protocol === void 0 && t2.hostname === void 0 && t2.port === void 0 && (e2.port = R(n2.port, r2)), t2.protocol === void 0 && t2.hostname === void 0 && t2.port === void 0 && t2.pathname === void 0 && (e2.pathname = R(n2.pathname, r2)), t2.protocol === void 0 && t2.hostname === void 0 && t2.port === void 0 && t2.pathname === void 0 && t2.search === void 0 && (e2.search = R(n2.search.substring(1, n2.search.length), r2)), t2.protocol === void 0 && t2.hostname === void 0 && t2.port === void 0 && t2.pathname === void 0 && t2.search === void 0 && t2.hash === void 0 && (e2.hash = R(n2.hash.substring(1, n2.hash.length), r2));
  } catch {
    throw new TypeError(`invalid baseURL '${t2.baseURL}'.`);
  }
  if (typeof t2.protocol == "string" && (e2.protocol = fe(t2.protocol, r2)), typeof t2.username == "string" && (e2.username = oe(t2.username, r2)), typeof t2.password == "string" && (e2.password = ae(t2.password, r2)), typeof t2.hostname == "string" && (e2.hostname = ie(t2.hostname, r2)), typeof t2.port == "string" && (e2.port = le(t2.port, e2.protocol, r2)), typeof t2.pathname == "string") {
    if (e2.pathname = t2.pathname, n2 && !ee(e2.pathname, r2)) {
      let c2 = n2.pathname.lastIndexOf("/");
      c2 >= 0 && (e2.pathname = R(n2.pathname.substring(0, c2 + 1), r2) + e2.pathname);
    }
    e2.pathname = ce(e2.pathname, e2.protocol, r2);
  }
  return typeof t2.search == "string" && (e2.search = se(t2.search, r2)), typeof t2.hash == "string" && (e2.hash = ne(t2.hash, r2)), e2;
}
function I(e2) {
  return e2.replace(/([+*?:{}()\\])/g, "\\$1");
}
...
function Ae(e2, t2) {
  ...
  let r2 = ".*", n2 = `[^${Te(t2.delimiter)}]+?`, c2 = /[$_\u200C\u200D\p{ID_Continue}]/u, l2 = "";
  for (let f2 = 0; f2 < e2.length; ++f2) {
    ...
    if (s2.type === 3) {
      ...
      l2 += `{${I(s2.value)}}${T(s2.modifier)}`;
      continue;
    }
    let i2 = s2.hasCustomName(), o2 = !!s2.suffix.length || !!s2.prefix.length && (s2.prefix.length !== 1 || !t2.prefixes.includes(s2.prefix)), h2 = f2 > 0 ? e2[f2 - 1] : null, p2 = f2 < e2.length - 1 ? e2[f2 + 1] : null;
    if (!o2 && i2 && s2.type === 1 && s2.modifier === 3 && p2 && !p2.prefix.length && !p2.suffix.length) if (p2.type === 3) {
      let A2 = p2.value.length > 0 ? p2.value[0] : "";
      o2 = c2.test(A2);
    } else o2 = !p2.hasCustomName();
    if (!o2 && !s2.prefix.length && h2 && h2.type === 3) {
      let A2 = h2.value[h2.value.length - 1];
      o2 = t2.prefixes.includes(A2);
    }
    o2 && (l2 += "{"), l2 += I(s2.prefix), i2 && (l2 += `:${s2.name}`), s2.type === 2 ? l2 += `(${s2.value})` : s2.type === 1 ? i2 || (l2 += `(${n2})`) : s2.type === 0 && (!i2 && (!h2 || h2.type === 3 || h2.modifier !== 3 || o2 || s2.prefix !== "") ? l2 += "*" : l2 += `(${r2})`), s2.type === 1 && i2 && s2.suffix.length && c2.test(s2.suffix[0]) && (l2 += "\\"), l2 += I(s2.suffix), o2 && (l2 += "}"), s2.modifier !== 3 && (l2 += T(s2.modifier));
  }
  return l2;
}
...
var init_urlpattern = __esm({
  "node_modules/.pnpm/urlpattern-polyfill@10.1.0/node_modules/urlpattern-polyfill/dist/urlpattern.js"() {
    ...
    a = (e2, t2) => Pe(e2, "name", { value: t2, configurable: true });
    P = class {
      type = 3;
      name = "";
      prefix = "";
      ...
      suffix = "";
      modifier = 3;
      constructor(t2, r2, n2, c2, l2, f2) {
        this.type = t2, this.name = r2, this.prefix = n2, this.value = c2, this.suffix = l2, this.modifier = f2;
      }
      hasCustomName() {
    ...
    Y = class {
      ...
      constructor(t2 = {}, r2, n2) {
        try {
          let c2;
          if (typeof r2 == "string" ? c2 = r2 : n2 = r2, typeof t2 == "string") {
            let i2 = new C(t2);
            if (i2.parse(), t2 = i2.result, c2 === void 0 && typeof t2.protocol != "string") throw new TypeError("A base URL must be provided for a relative constructor string.");
            t2.baseURL = c2;
          } else {
            if (!t2 || typeof t2 != "object") throw new TypeError("parameter 1 is not of type 'string' and cannot convert to dictionary.");
            if (c2) throw new TypeError("parameter 1 is not of type 'string'.");
          }
          typeof n2 > "u" && (n2 = { ignoreCase: false });
          let l2 = { ignoreCase: n2.ignoreCase === true }, f2 = { pathname: O, protocol: O, username: O, password: O, hostname: O, port: O, search: O, hash: O };
          this.#i = L(f2, t2, true), z(this.#i.protocol) === this.#i.port && (this.#i.port = "");
          let s2;
          for (s2 of V) {
            ...
            switch (this.#t[s2] = [], s2) {
              case "protocol":
                ...
                break;
              case "username":
                Object.assign(i2, b), i2.encodePart = he;
                break;
              case "password":
                Object.assign(i2, b), i2.encodePart = ue;
                break;
              case "hostname":
                Object.assign(i2, J), _(o2) ? i2.encodePart = K : i2.encodePart = j;
                break;
              case "port":
                Object.assign(i2, b), i2.encodePart = G;
                break;
              case "pathname":
                U(this.#n.protocol) ? (Object.assign(i2, Q, l2), i2.encodePart = de) : (Object.assign(i2, b, l2), i2.encodePart = pe);
                break;
              case "search":
                Object.assign(i2, b, l2), i2.encodePart = ge;
                break;
              case "hash":
                Object.assign(i2, b, l2), i2.encodePart = me;
                break;
            }
            try {
              this.#s[s2] = F(o2, i2), this.#n[s2] = W(this.#s[s2], this.#t[s2], i2), this.#e[s2] = Ae(this.#s[s2], i2), this.#l = this.#l || this.#s[s2].some((h2) => h2.type === 2);
            } catch {
              throw new TypeError(`invalid ${s2} pattern '${this.#i[s2]}'.`);
            }
          }
        } catch (c2) {
          throw new TypeError(`Failed to construct 'URLPattern': ${c2.message}`);
        }
      }
      ...
      test(t2 = {}, r2) {
        ...
        if (typeof t2 != "string" && r2) throw new TypeError("parameter 1 is not of type 'string'.");
        if (typeof t2 > "u") return false;
        try {
          typeof t2 == "object" ? n2 = L(n2, t2, false) : n2 = L(n2, Se(t2, r2), false);
        } catch {
          return false;
        }
        let c2;
        for (c2 of V) if (!this.#n[c2].exec(n2[c2])) return false;
        return true;
      }
      exec(t2 = {}, r2) {
        let n2 = { pathname: "", protocol: "", username: "", password: "", hostname: "", port: "", search: "", hash: "" };
        ...
        let c2 = {};
        r2 ? c2.inputs = [t2, r2] : c2.inputs = [t2];
        let l2;
        for (l2 of V) {
          let f2 = this.#n[l2].exec(n2[l2]);
          if (!f2) return null;
          let s2 = {};
          for (let [i2, o2] of this.#t[l2].entries()) if (typeof o2 == "string" || typeof o2 == "number") {
            let h2 = f2[i2 + 1];
            s2[o2] = h2;
          }
          c2[l2] = { input: n2[l2] ?? "", groups: s2 };
        }
        return c2;
      }
      static compareComponent(t2, r2, n2) {
        let c2 = a((i2, o2) => {
          for (let h2 of ["type", "modifier", "prefix", "value", "suffix"]) {
            if (i2[h2] < o2[h2]) return -1;
            if (i2[h2] === o2[h2]) continue;
            return 1;
          }
          return 0;
        }, "comparePart"), l2 = new P(3, "", "", "", "", 3), f2 = new P(0, "", "", "", "", 3), s2 = a((i2, o2) => {
          let h2 = 0;
          for (; h2 < Math.min(i2.length, o2.length); ++h2) {
            let p2 = c2(i2[h2], o2[h2]);
            if (p2) return p2;
          }
          return i2.length === o2.length ? 0 : c2(i2[h2] ?? l2, o2[h2] ?? l2);
        }, "comparePartList");
        return !r2.#e[t2] && !n2.#e[t2] ? 0 : r2.#e[t2] && !n2.#e[t2] ? s2(r2.#s[t2], [f2]) : !r2.#e[t2] && n2.#e[t2] ? s2([f2], n2.#s[t2]) : s2(r2.#s[t2], n2.#s[t2]);
      }
      get protocol() {
...
function q2(e2, t2) {
  e2._ownerReadableStream = t2, t2._reader = e2, "readable" === t2._state ? B2(e2) : "closed" === t2._state ? function(e3) {
    B2(e3), A(e3);
...
function W2(e2) {
  ...
  "readable" === t2._state ? j2(e2, new TypeError("Reader was released and can no longer be used to monitor the stream's closedness")) : function(e3, t3) {
    k(e3, t3);
  }(e2, new TypeError("Reader was released and can no longer be used to monitor the stream's closedness")), t2._readableStreamController[P2](), t2._reader = void 0, e2._ownerReadableStream = void 0;
}
function O2(e2) {
...
function Q2(e2, t2) {
  ...
  let o2 = Number(e2);
  if (o2 = x2(o2), !z2(o2)) throw new TypeError(`${t2} is not a finite number`);
  if (o2 = function(e3) {
    return x2(D2(e3));
...
function K2(e2, t2) {
  ...
  r2._disturbed = true, "closed" === r2._state ? t2._closeSteps() : "errored" === r2._state ? t2._errorSteps(r2._storedError) : r2._readableStreamController[C2](t2);
}
function Z(e2, t2) {
  const r2 = e2._readRequests;
  e2._readRequests = new v2(), r2.forEach((e3) => {
    e3._errorSteps(t2);
  });
}
function ee2(e2) {
...
function fe2(e2, r2 = "sync", o2) {
  if (void 0 === o2) if ("async" === r2) {
    if (void 0 === (o2 = ue2(e2, de2))) {
      return function(e3) {
        const r3 = { next() {
          let t2;
          try {
          ...
          let o3;
          try {
            const t2 = ue2(e3.iterator, "return");
            if (void 0 === t2) return c({ done: true, value: r4 });
            o3 = S(t2, e3.iterator, [r4]);
          } catch (e4) {
            return d(e4);
          }
          return t(o3) ? ce2(o3) : d(new TypeError("The iterator.return() method must return an object"));
        } };
        return { iterator: r3, nextMethod: r3.next, done: false };
      }(fe2(e2, "sync", ue2(e2, Symbol.iterator)));
    }
  } else o2 = ue2(e2, Symbol.iterator);
...
function _e(e2) {
  ...
  try {
    return e2._asyncIteratorImpl instanceof he2;
  } catch (e3) {
    return false;
  }
}
...
function Se2(e2) {
  const t2 = se2(e2.buffer, e2.byteOffset, e2.byteOffset + e2.byteLength);
...
function we(e2) {
  e2._queue = new v2(), e2._queueTotalSize = 0;
}
function Re2(e2) {
  return e2 === DataView;
}
...
function Pe2(e2) {
  ...
  e2._pulling = true;
  b2(e2._pullAlgorithm(), () => (e2._pulling = false, e2._pullAgain && (e2._pullAgain = false, Pe2(e2)), null), (t3) => (Ne(e2, t3), null));
}
function qe(e2) {
  Le(e2), e2._pendingPullIntos = new v2();
}
function Ee2(e2, t2) {
  let r2 = false;
  "closed" === e2._state && (r2 = true);
  const o2 = Oe2(t2);
  "default" === t2.readerType ? U2(e2, o2, r2) : function(e3, t3, r3) {
    const o3 = e3._reader, n2 = o3._readIntoRequests.shift();
    r3 ? n2._closeSteps(t3) : n2._chunkSteps(t3);
  }(e2, o2, r2);
}
function We(e2, t2) {
  for (let r2 = 0; r2 < t2.length; ++r2) Ee2(e2, t2[r2]);
}
function Oe2(e2) {
...
function je(e2, t2) {
  t2.bytesFilled > 0 && ke2(e2, t2.buffer, t2.byteOffset, t2.bytesFilled), Me(e2);
}
function Ae2(e2, t2) {
  const r2 = Math.min(e2._queueTotalSize, t2.byteLength - t2.bytesFilled), o2 = t2.bytesFilled + r2;
  let n2 = r2, a3 = false;
  const i2 = o2 - o2 % t2.elementSize;
  i2 >= t2.minimumFill && (n2 = i2 - t2.bytesFilled, a3 = true);
  const l2 = e2._queue;
  for (; n2 > 0; ) {
    const r3 = l2.peek(), o3 = Math.min(n2, r3.byteLength), a4 = t2.byteOffset + t2.bytesFilled;
    ae2(t2.buffer, a4, r3.buffer, r3.byteOffset, o3), r3.byteLength === o3 ? l2.shift() : (r3.byteOffset += o3, r3.byteLength -= o3), e2._queueTotalSize -= o3, ze(e2, o3, t2), n2 -= o3;
  }
  return a3;
}
...
function De(e2) {
  0 === e2._queueTotalSize && e2._closeRequested ? (Ye(e2), Br(e2._controlledReadableByteStream)) : Pe2(e2);
}
function Le(e2) {
...
function Ie(e2, t2, r2, o2) {
  ...
  const d2 = { buffer: c2, bufferByteLength: c2.byteLength, byteOffset: l2, byteLength: s2, bytesFilled: 0, minimumFill: u2, elementSize: i2, viewConstructor: a3, readerType: "byob" };
  if (e2._pendingPullIntos.length > 0) return e2._pendingPullIntos.push(d2), void rt(n2, o2);
  if ("closed" === n2._state) {
    const e3 = new a3(d2.buffer, d2.byteOffset, 0);
  ...
  e2._pendingPullIntos.push(d2), rt(n2, o2), Pe2(e2);
}
function $e(e2, t2) {
  const r2 = e2._pendingPullIntos.peek();
  Le(e2);
  "closed" === e2._controlledReadableByteStream._state ? function(e3, t3) {
    ...
    if (o2 > 0) {
      ...
      ke2(e3, r3.buffer, t4 - o2, o2);
    }
    r3.bytesFilled -= o2;
    const n2 = Fe(e3);
    Ee2(e3._controlledReadableByteStream, r3), We(e3._controlledReadableByteStream, n2);
  }(e2, t2, r2), Pe2(e2);
}
function Me(e2) {
...
function Qe(e2, t2) {
  ...
  const { buffer: o2, byteOffset: n2, byteLength: a3 } = t2;
  if (le2(o2)) throw new TypeError("chunk's buffer is detached and so cannot be enqueued");
  const i2 = ie2(o2);
  if (e2._pendingPullIntos.length > 0) {
    const t3 = e2._pendingPullIntos.peek();
    if (le2(t3.buffer)) throw new TypeError("The BYOB request's buffer has been detached and so cannot be filled with an enqueued chunk");
    Le(e2), t3.buffer = ie2(t3.buffer), "none" === t3.readerType && je(e2, t3);
  }
  ...
  }(e2), 0 === G2(r2)) Be(e2, i2, n2, a3);
  else {
    e2._pendingPullIntos.length > 0 && Me(e2);
    U2(r2, new Uint8Array(i2, n2, a3), false);
  }
  else if (nt(r2)) {
    Be(e2, i2, n2, a3);
    We(r2, Fe(e2));
...
function Ge(e2, t2) {
  ...
  r2.buffer = ie2(r2.buffer), $e(e2, t2);
}
function Xe(e2, t2) {
  const r2 = e2._pendingPullIntos.peek();
  if ("closed" === e2._controlledReadableByteStream._state) {
  ...
  r2.buffer = ie2(t2.buffer), $e(e2, o2);
}
function Je(e2, t2, r2, o2, n2, a3, i2) {
  t2._controlledReadableByteStream = e2, t2._pullAgain = false, t2._pulling = false, t2._byobRequest = null, t2._queue = t2._queueTotalSize = void 0, we(t2), t2._closeRequested = false, t2._started = false, t2._strategyHWM = a3, t2._pullAlgorithm = o2, t2._cancelAlgorithm = n2, t2._autoAllocateChunkSize = i2, t2._pendingPullIntos = new v2(), e2._readableStreamController = t2;
  b2(c(r2()), () => (t2._started = true, Pe2(t2), null), (e3) => (Ne(t2, e3), null));
}
function Ke(e2) {
...
function lt(e2, t2) {
  ...
  e2._readIntoRequests = new v2(), r2.forEach((e3) => {
    e3._errorSteps(t2);
  });
}
function st(e2) {
...
function dt(e2, t2) {
  ...
  return { highWaterMark: void 0 === r2 ? void 0 : Y2(r2), size: void 0 === o2 ? void 0 : ft(o2, `${t2} has member 'size' that`) };
}
function ft(e2, t2) {
  return F2(e2, t2), (t3) => Y2(e2(t3));
}
function bt(e2, t2, r2) {
  return F2(e2, r2), (r3) => g(e2, t2, [r3]);
}
function ht(e2, t2, r2) {
  return F2(e2, r2), () => g(e2, t2, []);
}
function mt(e2, t2, r2) {
  return F2(e2, r2), (r3) => S(e2, t2, [r3]);
}
function _t(e2, t2, r2) {
  return F2(e2, r2), (r3, o2) => g(e2, t2, [r3, o2]);
}
function pt(e2, t2) {
...
function St(e2) {
  e2._state = "writable", e2._storedError = void 0, e2._writer = void 0, e2._writableStreamController = void 0, e2._writeRequests = new v2(), e2._inFlightWriteRequest = void 0, e2._closeRequest = void 0, e2._inFlightCloseRequest = void 0, e2._pendingAbortRequest = void 0, e2._backpressure = false;
}
function gt(e2) {
...
function wt(e2, t2) {
  ...
  return e2._pendingAbortRequest._promise = a3, n2 || Ct(e2, t2), a3;
}
function Rt(e2) {
  const t2 = e2._state;
...
function Pt(e2) {
  e2._state = "errored", e2._writableStreamController[R2]();
  const t2 = e2._storedError;
  if (e2._writeRequests.forEach((e3) => {
    e3._reject(t2);
  }), e2._writeRequests = new v2(), void 0 === e2._pendingAbortRequest) return void Et(e2);
  const r2 = e2._pendingAbortRequest;
  if (e2._pendingAbortRequest = void 0, r2._wasAlreadyErroring) return r2._reject(t2), void Et(e2);
  b2(e2._writableStreamController[w2](r2._reason), () => (r2._resolve(), Et(e2), null), (t3) => (r2._reject(t3), Et(e2), null));
}
function qt(e2) {
...
function zt(e2, t2) {
  ...
  const a3 = r2._state;
  if ("errored" === a3) return d(r2._storedError);
  if (qt(r2) || "closed" === a3) return d(new TypeError("The stream is closing or closed and cannot be written to"));
  if ("erroring" === a3) return d(r2._storedError);
...
function Ft(e2, t2, r2, o2, n2, a3, i2, l2) {
  ...
  }(), t2._started = false, t2._strategySizeAlgorithm = l2, t2._strategyHWM = i2, t2._writeAlgorithm = o2, t2._closeAlgorithm = n2, t2._abortAlgorithm = a3;
  const s2 = xt(t2);
  Wt(e2, s2);
  b2(c(r2()), () => (t2._started = true, Mt(t2), null), (r3) => (t2._started = true, Tt(e2, r3), null));
}
function It(e2) {
...
function ir(t2, r2, o2, n2, a3, i2) {
  const l2 = H(t2), s2 = yt(r2);
  t2._disturbed = true;
  let _3 = false, y2 = c(void 0);
  return u((S2, g2) => {
    let v3;
    if (void 0 !== i2) {
      if (v3 = () => {
        const e2 = void 0 !== i2.reason ? i2.reason : new ar("Aborted", "AbortError"), o3 = [];
        n2 || o3.push(() => "writable" === r2._state ? wt(r2, e2) : c(void 0)), a3 || o3.push(() => "readable" === t2._state ? Or(t2, e2) : c(void 0)), q3(() => Promise.all(o3.map((e3) => e3())), true, e2);
      }, i2.aborted) return void v3();
      i2.addEventListener("abort", v3);
    }
    var w3, R3, T3;
    if (P3(t2, l2._closedPromise, (e2) => (n2 ? E2(true, e2) : q3(() => wt(r2, e2), true, e2), null)), P3(r2, s2._closedPromise, (e2) => (a3 ? E2(true, e2) : q3(() => Or(t2, e2), true, e2), null)), w3 = t2, R3 = l2._closedPromise, T3 = () => (o2 ? E2() : q3(() => function(e2) {
      const t3 = e2._ownerWritableStream, r3 = t3._state;
      return qt(t3) || "closed" === r3 ? c(void 0) : "errored" === r3 ? d(t3._storedError) : Bt(e2);
    }(s2)), null), "closed" === w3._state ? T3() : h(R3, T3), qt(r2) || "closed" === r2._state) {
    ...
    function C3() {
      const e2 = y2;
      return f(y2, () => e2 !== y2 ? C3() : void 0);
    }
    function P3(e2, t3, r3) {
      "errored" === e2._state ? r3(e2._storedError) : m(t3, r3);
    }
    function q3(e2, t3, o3) {
      function n3() {
        return b2(e2(), () => O3(t3, o3), (e3) => O3(true, e3)), null;
      }
      _3 || (_3 = true, "writable" !== r2._state || qt(r2) ? n3() : h(C3(), n3));
    }
    function E2(e2, t3) {
      _3 || (_3 = true, "writable" !== r2._state || qt(r2) ? O3(e2, t3) : h(C3(), () => O3(e2, t3)));
    }
    function O3(e2, t3) {
      return At(s2), W2(l2), void 0 !== i2 && i2.removeEventListener("abort", v3), e2 ? g2(t3) : S2(void 0), null;
    }
    p(u((t3, r3) => {
      !function o3(n3) {
        n3 ? t3() : f(_3 ? c(true) : f(s2._readyPromise, () => u((t4, r4) => {
          K2(l2, { _chunkSteps: (r5) => {
...
function sr(e2) {
  ...
  if (e2._pulling) return void (e2._pullAgain = true);
  e2._pulling = true;
  b2(e2._pullAlgorithm(), () => (e2._pulling = false, e2._pullAgain && (e2._pullAgain = false, sr(e2)), null), (t2) => (br(e2, t2), null));
}
function ur(e2) {
  const t2 = e2._controlledReadableStream;
  if (!mr(e2)) return false;
  if (!e2._started) return false;
  if (Wr(t2) && G2(t2) > 0) return true;
  return hr(e2) > 0;
}
function cr(e2) {
...
function fr(e2, t2) {
  ...
  if (Wr(r2) && G2(r2) > 0) U2(r2, t2, false);
  else {
    let r3;
    try {
...
function _r(e2, t2, r2, o2, n2, a3, i2) {
  t2._controlledReadableStream = e2, t2._queue = void 0, t2._queueTotalSize = void 0, we(t2), t2._started = false, t2._closeRequested = false, t2._pullAgain = false, t2._pulling = false, t2._strategySizeAlgorithm = i2, t2._strategyHWM = a3, t2._pullAlgorithm = o2, t2._cancelAlgorithm = n2, e2._readableStreamController = t2;
  b2(c(r2()), () => (t2._started = true, sr(t2), null), (e3) => (br(t2, e3), null));
}
function pr(e2) {
  return new TypeError(`ReadableStreamDefaultController.prototype.${e2} can only be used on a ReadableStreamDefaultController`);
}
function yr(e2, t2) {
  return Te2(e2._readableStreamController) ? function(e3) {
    let t3, r2, o2, n2, a3, i2 = H(e3), l2 = false, s2 = false, d2 = false, f2 = false, b3 = false;
    const h2 = u((e4) => {
      a3 = e4;
    });
    function _3(e4) {
      m(e4._closedPromise, (t4) => (e4 !== i2 || (Ne(o2._readableStreamController, t4), Ne(n2._readableStreamController, t4), f2 && b3 || a3(void 0)), null));
    }
    function p2() {
      at(i2) && (W2(i2), i2 = H(e3), _3(i2));
      K2(i2, { _chunkSteps: (t4) => {
        y(() => {
          s2 = false, d2 = false;
          const r3 = t4;
          let i3 = t4;
          if (!f2 && !b3) try {
            ...
            return Ne(o2._readableStreamController, t5), Ne(n2._readableStreamController, t5), void a3(Or(e3, t5));
          }
          f2 || Qe(o2._readableStreamController, r3), b3 || Qe(n2._readableStreamController, i3), l2 = false, s2 ? g2() : d2 && v3();
        });
      }, _closeSteps: () => {
        l2 = false, f2 || xe(o2._readableStreamController), b3 || xe(n2._readableStreamController), o2._readableStreamController._pendingPullIntos.length > 0 && Ge(o2._readableStreamController, 0), n2._readableStreamController._pendingPullIntos.length > 0 && Ge(n2._readableStreamController, 0), f2 && b3 || a3(void 0);
      }, _errorSteps: () => {
        l2 = false;
      } });
    }
    function S2(t4, r3) {
      J2(i2) && (W2(i2), i2 = tt(e3), _3(i2));
      const u2 = r3 ? n2 : o2, c2 = r3 ? o2 : n2;
      it(i2, t4, 1, { _chunkSteps: (t5) => {
        y(() => {
          s2 = false, d2 = false;
          const o3 = r3 ? b3 : f2;
          if (r3 ? f2 : b3) o3 || Xe(u2._readableStreamController, t5);
          else {
            let r4;
            try {
              r4 = Se2(t5);
            } catch (t6) {
              return Ne(u2._readableStreamController, t6), Ne(c2._readableStreamController, t6), void a3(Or(e3, t6));
            }
            o3 || Xe(u2._readableStreamController, t5), Qe(c2._readableStreamController, r4);
          }
          l2 = false, s2 ? g2() : d2 && v3();
        });
      }, _closeSteps: (e4) => {
        l2 = false;
        const t5 = r3 ? b3 : f2, o3 = r3 ? f2 : b3;
        t5 || xe(u2._readableStreamController), o3 || xe(c2._readableStreamController), void 0 !== e4 && (t5 || Xe(u2._readableStreamController, e4), !o3 && c2._readableStreamController._pendingPullIntos.length > 0 && Ge(c2._readableStreamController, 0)), t5 && o3 || a3(void 0);
      }, _errorSteps: () => {
        l2 = false;
      } });
    }
    ...
    function w3(o3) {
      if (f2 = true, t3 = o3, b3) {
        const o4 = ne2([t3, r2]), n3 = Or(e3, o4);
        a3(n3);
      }
      return h2;
    }
    ...
    return o2 = Pr(T3, g2, w3), n2 = Pr(T3, v3, R3), _3(i2), [o2, n2];
  }(e2) : function(e3) {
    const t3 = H(e3);
    ...
    function _3(t4) {
      if (d2 = true, r2 = t4, f2) {
        const t5 = ne2([r2, o2]), n3 = Or(e3, t5);
        i2(n3);
      }
      return b3;
    }
    ...
    return n2 = Cr(S2, h2, _3), a3 = Cr(S2, h2, p2), m(t3._closedPromise, (e4) => (br(n2._readableStreamController, e4), br(a3._readableStreamController, e4), d2 && f2 || i2(void 0), null)), [n2, a3];
  }(e2);
}
function Sr(r2) {
  return t(o2 = r2) && void 0 !== o2.getReader ? function(r3) {
    ...
    return o3 = Cr(e, n2, a3, 0), o3;
  }(r2.getReader()) : function(r3) {
    let o3;
    const n2 = fe2(r3, "async");
    function a3() {
      let e2;
      try {
        e2 = be(n2);
...
function Tr(e2, t2) {
  L2(e2, t2);
  const r2 = null == e2 ? void 0 : e2.preventAbort, o2 = null == e2 ? void 0 : e2.preventCancel, n2 = null == e2 ? void 0 : e2.preventClose, a3 = null == e2 ? void 0 : e2.signal;
  return void 0 !== a3 && function(e3, t3) {
    if (!function(e4) {
  ...
  }(a3, `${t2} has member 'signal' that`), { preventAbort: Boolean(r2), preventCancel: Boolean(o2), preventClose: Boolean(n2), signal: a3 };
}
function Cr(e2, t2, r2, o2 = 1, n2 = () => 1) {
  const a3 = Object.create(ReadableStream2.prototype);
  qr(a3);
  return _r(a3, Object.create(ReadableStreamDefaultController.prototype), e2, t2, r2, o2, n2), a3;
}
...
function Or(t2, r2) {
  ...
  if (void 0 !== o2 && at(o2)) {
    ...
    o2._readIntoRequests = new v2(), e2.forEach((e3) => {
      e3._closeSteps(void 0);
    });
  }
  return _2(t2._readableStreamController[T2](r2), e);
}
function Br(e2) {
  e2._state = "closed";
  const t2 = e2._reader;
  if (void 0 !== t2 && (A(t2), J2(t2))) {
    const e3 = t2._readRequests;
    t2._readRequests = new v2(), e3.forEach((e4) => {
      e4._closeSteps();
    });
  }
}
function kr(e2, t2) {
  ...
  const r2 = e2._reader;
  void 0 !== r2 && (j2(r2, t2), J2(r2) ? Z(r2, t2) : lt(r2, t2));
}
function jr(e2) {
...
function Ar(e2, t2) {
  ...
  return M(r2, "highWaterMark", "QueuingStrategyInit"), { highWaterMark: Y2(r2) };
}
function Dr(e2) {
...
function Zr(e2, t2) {
  return _2(e2._transformAlgorithm(t2), void 0, (t3) => {
...
var r, n, a2, i, l, s, y, v2, w2, R2, T2, C2, P2, z2, D2, ReadableStreamDefaultReader, te2, re2, oe2, ie2, le2, de2, he2, me2, ye, ReadableStreamBYOBRequest, ReadableByteStreamController, ReadableStreamBYOBReader, WritableStream2, WritableStreamDefaultWriter, Dt, WritableStreamDefaultController, nr, ar, ReadableStreamDefaultController, ReadableStream2, zr, ByteLengthQueuingStrategy, Fr, CountQueuingStrategy, TransformStream, TransformStreamDefaultController;
var init_ponyfill = __esm({
  "node_modules/.pnpm/web-streams-polyfill@4.2.0/node_modules/web-streams-polyfill/dist/ponyfill.mjs"() {
    r = e;
    n = Promise;
    a2 = Promise.resolve.bind(n);
    i = Promise.prototype.then;
    l = Promise.reject.bind(n);
    s = a2;
    y = (e2) => {
    ...
    v2 = class {
      ...
      shift() {
        ...
        let o2 = r2 + 1;
        const n2 = e2._elements, a3 = n2[r2];
        return 16384 === o2 && (t2 = e2._next, o2 = 0), --this._size, this._cursor = o2, e2 !== t2 && (this._front = t2), n2[r2] = void 0, a3;
      }
      forEach(e2) {
    ...
    w2 = Symbol("[[AbortSteps]]");
    R2 = Symbol("[[ErrorSteps]]");
    T2 = Symbol("[[CancelSteps]]");
    C2 = Symbol("[[PullSteps]]");
    P2 = Symbol("[[ReleaseSteps]]");
    z2 = Number.isFinite || function(e2) {
      return "number" == typeof e2 && isFinite(e2);
    };
    D2 = Math.trunc || function(e2) {
    ...
    ReadableStreamDefaultReader = class {
      constructor(e2) {
        ...
        q2(this, e2), this._readRequests = new v2();
      }
      get closed() {
        return J2(this) ? this._closedPromise : d(ee2("closed"));
      }
      cancel(e2 = void 0) {
        return J2(this) ? void 0 === this._ownerReadableStream ? d(O2("cancel")) : E(this, e2) : d(ee2("cancel"));
      }
      read() {
        if (!J2(this)) return d(ee2("read"));
        if (void 0 === this._ownerReadableStream) return d(O2("read from"));
        let e2, t2;
        const r2 = u((r3, o2) => {
          e2 = r3, t2 = o2;
        });
        return K2(this, { _chunkSteps: (t3) => e2({ value: t3, done: false }), _closeSteps: () => e2({ value: void 0, done: true }), _errorSteps: (e3) => t2(e3) }), r2;
      }
      releaseLock() {
        if (!J2(this)) throw ee2("releaseLock");
    ...
    ie2 = (e2) => (ie2 = "function" == typeof e2.transfer ? (e3) => e3.transfer() : "function" == typeof structuredClone ? (e3) => structuredClone(e3, { transfer: [e3] }) : (e3) => e3, ie2(e2));
    le2 = (e2) => (le2 = "boolean" == typeof e2.detached ? (e3) => e3.detached : (e3) => 0 === e3.byteLength, le2(e2));
    de2 = null !== (oe2 = null !== (te2 = Symbol.asyncIterator) && void 0 !== te2 ? te2 : null === (re2 = Symbol.for) || void 0 === re2 ? void 0 : re2.call(Symbol, "Symbol.asyncIterator")) && void 0 !== oe2 ? oe2 : "@@asyncIterator";
    he2 = class {
      constructor(e2, t2) {
      ...
      next() {
        ...
        return this._ongoingPromise = this._ongoingPromise ? _2(this._ongoingPromise, e2, e2) : e2(), this._ongoingPromise;
      }
      return(e2) {
        const t2 = () => this._returnSteps(e2);
        return this._ongoingPromise = this._ongoingPromise ? _2(this._ongoingPromise, t2, t2) : t2(), this._ongoingPromise;
      }
      _nextSteps() {
        ...
        return K2(e2, { _chunkSteps: (e3) => {
          this._ongoingPromise = void 0, y(() => t2({ value: e3, done: false }));
        }, _closeSteps: () => {
          this._ongoingPromise = void 0, this._isFinished = true, W2(e2), t2({ value: void 0, done: true });
        }, _errorSteps: (t3) => {
          this._ongoingPromise = void 0, this._isFinished = true, W2(e2), r2(t3);
        } }), o2;
      }
      _returnSteps(e2) {
        ...
        if (!this._preventCancel) {
          const r2 = E(t2, e2);
          return W2(t2), _2(r2, () => ({ value: e2, done: true }));
        }
        return W2(t2), c({ value: e2, done: true });
      }
    };
    me2 = { next() {
      return _e(this) ? this._asyncIteratorImpl.next() : d(pe2("next"));
    }, return(e2) {
      return _e(this) ? this._asyncIteratorImpl.return(e2) : d(pe2("return"));
    }, [de2]() {
      return this;
    } };
    Object.defineProperty(me2, de2, { enumerable: false });
    ye = Number.isNaN || function(e2) {
      return e2 != e2;
    };
    ReadableStreamBYOBRequest = class {
      ...
      respond(e2) {
        ...
        if ($(e2, 1, "respond"), e2 = Q2(e2, "First parameter"), void 0 === this._associatedReadableByteStreamController) throw new TypeError("This BYOB request has been invalidated");
        if (le2(this._view.buffer)) throw new TypeError("The BYOB request's buffer has been detached and so cannot be used as a response");
      ...
      respondWithNewView(e2) {
        ...
        if (le2(e2.buffer)) throw new TypeError("The given view's buffer has been detached and so cannot be used as a response");
    ...
    ReadableByteStreamController = class {
      ...
      get byobRequest() {
        if (!Te2(this)) throw Ze("byobRequest");
        return Ve(this);
      }
      get desiredSize() {
        if (!Te2(this)) throw Ze("desiredSize");
        return Ue(this);
      }
      close() {
        if (!Te2(this)) throw Ze("close");
      ...
      [P2]() {
        if (this._pendingPullIntos.length > 0) {
          ...
          e2.readerType = "none", this._pendingPullIntos = new v2(), this._pendingPullIntos.push(e2);
        }
      }
    };
    ...
    ReadableStreamBYOBReader = class {
      constructor(e2) {
        ...
        if (!Te2(e2._readableStreamController)) throw new TypeError("Cannot construct a ReadableStreamBYOBReader for a stream not constructed with a byte source");
        q2(this, e2), this._readIntoRequests = new v2();
      }
      get closed() {
        return at(this) ? this._closedPromise : d(st("closed"));
      }
      cancel(e2 = void 0) {
        return at(this) ? void 0 === this._ownerReadableStream ? d(O2("cancel")) : E(this, e2) : d(st("cancel"));
      }
      read(e2, t2 = {}) {
        ...
        if (le2(e2.buffer)) return d(new TypeError("view's buffer has been detached"));
        let r2;
        try {
          r2 = function(e3, t3) {
            var r3;
            return L2(e3, t3), { min: Q2(null !== (r3 = null == e3 ? void 0 : e3.min) && void 0 !== r3 ? r3 : 1, `${t3} has member 'min' that`) };
          }(t2, "options");
        } catch (e3) {
          return d(e3);
        }
        ...
        return it(this, e2, o2, { _chunkSteps: (e3) => n2({ value: e3, done: false }), _closeSteps: (e3) => n2({ value: e3, done: true }), _errorSteps: (e3) => a3(e3) }), i2;
      }
      releaseLock() {
    ...
    WritableStream2 = class {
      constructor(e2 = {}, t2 = {}) {
        void 0 === e2 ? e2 = null : I2(e2, "First parameter");
        const r2 = dt(t2, "Second parameter"), o2 = function(e3, t3) {
          ...
          return { abort: void 0 === r3 ? void 0 : bt(r3, e3, `${t3} has member 'abort' that`), close: void 0 === o3 ? void 0 : ht(o3, e3, `${t3} has member 'close' that`), start: void 0 === n3 ? void 0 : mt(n3, e3, `${t3} has member 'start' that`), write: void 0 === i2 ? void 0 : _t(i2, e3, `${t3} has member 'write' that`), type: a3 };
        }(e2, "First parameter");
        St(this);
    ...
    ReadableStream2 = class {
      constructor(e2 = {}, t2 = {}) {
        ...
        const r2 = dt(t2, "Second parameter"), o2 = function(e3, t3) {
          L2(e3, t3);
          const r3 = e3, o3 = null == r3 ? void 0 : r3.autoAllocateChunkSize, n2 = null == r3 ? void 0 : r3.cancel, a3 = null == r3 ? void 0 : r3.pull, i2 = null == r3 ? void 0 : r3.start, l2 = null == r3 ? void 0 : r3.type;
          return { autoAllocateChunkSize: void 0 === o3 ? void 0 : Q2(o3, `${t3} has member 'autoAllocateChunkSize' that`), cancel: void 0 === n2 ? void 0 : gr(n2, r3, `${t3} has member 'cancel' that`), pull: void 0 === a3 ? void 0 : vr(a3, r3, `${t3} has member 'pull' that`), start: void 0 === i2 ? void 0 : wr(i2, r3, `${t3} has member 'start' that`), type: void 0 === l2 ? void 0 : Rr(l2, `${t3} has member 'type' that`) };
        }(e2, "First parameter");
        if (qr(this), "bytes" === o2.type) {
          ...
          !function(e3, t3, r3) {
            ...
            }, a3 = void 0 !== t3.pull ? () => t3.pull(o3) : () => c(void 0), i2 = void 0 !== t3.cancel ? (e4) => t3.cancel(e4) : () => c(void 0);
            const l2 = t3.autoAllocateChunkSize;
            if (0 === l2) throw new TypeError("autoAllocateChunkSize must be greater than 0");
            Je(e3, o3, n2, a3, i2, r3, l2);
          }(this, o2, ut(r2, 0));
        } else {
          const e3 = ct(r2);
          !function(e4, t3, r3, o3) {
            ...
            let a3, i2, l2;
            a3 = void 0 !== t3.start ? () => t3.start(n2) : () => {
            }, i2 = void 0 !== t3.pull ? () => t3.pull(n2) : () => c(void 0), l2 = void 0 !== t3.cancel ? (e5) => t3.cancel(e5) : () => c(void 0), _r(e4, n2, a3, i2, l2, r3, o3);
          }(this, o2, ut(r2, 1), e3);
        }
      }
      get locked() {
      ...
      values(e2 = void 0) {
        ...
        return function(e3, t2) {
          const r2 = H(e3), o2 = new he2(r2, t2), n2 = Object.create(me2);
    ...
    TransformStream = class {
      constructor(e2 = {}, t2 = {}, r2 = {}) {
        void 0 === e2 && (e2 = null);
        const o2 = dt(t2, "Second parameter"), n2 = dt(r2, "Third parameter"), a3 = function(e3, t3) {
          L2(e3, t3);
          const r3 = null == e3 ? void 0 : e3.cancel, o3 = null == e3 ? void 0 : e3.flush, n3 = null == e3 ? void 0 : e3.readableType, a4 = null == e3 ? void 0 : e3.start, i3 = null == e3 ? void 0 : e3.transform, l3 = null == e3 ? void 0 : e3.writableType;
          return { cancel: void 0 === r3 ? void 0 : Qr(r3, e3, `${t3} has member 'cancel' that`), flush: void 0 === o3 ? void 0 : Mr(o3, e3, `${t3} has member 'flush' that`), readableType: n3, start: void 0 === a4 ? void 0 : Yr(a4, e3, `${t3} has member 'start' that`), transform: void 0 === i3 ? void 0 : xr(i3, e3, `${t3} has member 'transform' that`), writableType: l3 };
        }(e2, "First parameter");
        ...
        !function(e3, t3, r3, o3, n3, a4) {
          ...
          function l3(t4) {
            return function(e4, t5) {
              ...
              if (e4._backpressure) {
                return _2(e4._backpressureChangePromise, () => {
          ...
          function s3(t4) {
            return function(e4, t5) {
              ...
              return Jr(r4), b2(n4, () => ("errored" === o4._state ? ro(r4, o4._storedError) : (br(o4._readableStreamController, t5), to(r4)), null), (e5) => (br(o4._readableStreamController, e5), ro(r4, e5), null)), r4._finishPromise;
            }(e3, t4);
          }
          function c2() {
            return function(e4) {
              ...
              return Jr(t4), b2(o4, () => ("errored" === r4._state ? ro(t4, r4._storedError) : (dr(r4._readableStreamController), to(t4)), null), (e5) => (br(r4._readableStreamController, e5), ro(t4, e5), null)), t4._finishPromise;
            }(e3);
          }
          function d2() {
            return function(e4) {
          ...
          function f3(t4) {
            return function(e4, t5) {
              ...
              const n4 = r4._cancelAlgorithm(t5);
              return Jr(r4), b2(n4, () => ("errored" === o4._state ? ro(r4, o4._storedError) : (Yt(o4._writableStreamController, t5), Ur(e4), to(r4)), null), (t6) => (Yt(o4._writableStreamController, t6), Ur(e4), ro(r4, t6), null)), r4._finishPromise;
            }(e3, t4);
          }
          ...
          }(i3, l3, c2, s3, r3, o3), e3._readable = Cr(i3, d2, f3, n3, a4), e3._backpressure = void 0, e3._backpressureChangePromise = void 0, e3._backpressureChangePromise_resolve = void 0, Gr(e3, true), e3._transformStreamController = void 0;
        }(this, u((e3) => {
          h2 = e3;
          ...
          a4 = void 0 !== t3.cancel ? (e4) => t3.cancel(e4) : () => c(void 0);
...
// node_modules/.pnpm/blob-polyfill@9.0.20240710/node_modules/blob-polyfill/Blob.js
var require_Blob = __commonJS({
  "node_modules/.pnpm/blob-polyfill@9.0.20240710/node_modules/blob-polyfill/Blob.js"(exports) {
    ...
    (function(global2) {
      (function(factory) {
        ...
        var URL3 = global2.URL || global2.webkitURL || function(href, a3) {
          a3 = document.createElement("a");
          a3.href = href;
          return a3;
        };
        var origBlob = global2.Blob;
        var createObjectURL = URL3.createObjectURL;
        var revokeObjectURL = URL3.revokeObjectURL;
        ...
        if (global2.Blob) {
          BlobBuilderConstructor.prototype = global2.Blob.prototype;
          BlobConstructor.prototype = global2.Blob.prototype;
        }
        ...
        function FakeBlobBuilder() {
          ...
          function getObjectTypeName(o2) {
            return Object.prototype.toString.call(o2).slice(8, -1);
          }
          function isPrototypeOf(c2, o2) {
            return typeof c2 === "object" && Object.prototype.isPrototypeOf.call(c2.prototype, o2);
          }
          function isDataView(o2) {
            return getObjectTypeName(o2) === "DataView" || isPrototypeOf(global2.DataView, o2);
          }
          ...
          function isArrayBuffer(o2) {
            return includes(arrayBufferClassNames, getObjectTypeName(o2)) || isPrototypeOf(global2.ArrayBuffer, o2);
          }
          ...
          function Blob2(chunks, opts) {
            chunks = chunks ? chunks.slice() : [];
            opts = opts == null ? {} : opts;
            for (var i2 = 0, len = chunks.length; i2 < len; i2++) {
              var chunk = chunks[i2];
              if (chunk instanceof Blob2) {
                chunks[i2] = chunk._buffer;
              } else if (typeof chunk === "string") {
                chunks[i2] = textEncode(chunk);
              } else if (isDataView(chunk)) {
                chunks[i2] = bufferClone(chunk.buffer);
              } else if (isArrayBuffer(chunk)) {
                chunks[i2] = bufferClone(chunk);
              } else {
                chunks[i2] = textEncode(String(chunk));
              }
            }
          ...
          Blob2.isPolyfill = true;
          Blob2.prototype.arrayBuffer = function() {
            return Promise.resolve(this._buffer.buffer || this._buffer);
          };
          Blob2.prototype.text = function() {
            return Promise.resolve(textDecode(this._buffer));
          };
          Blob2.prototype.slice = function(start, end, type) {
          ...
          function File2(chunks, name, opts) {
            opts = opts || {};
            var a3 = Blob2.call(this, chunks, opts) || this;
            a3.name = name.replace(/\//g, ":");
            a3.lastModifiedDate = opts.lastModified ? new Date(opts.lastModified) : /* @__PURE__ */ new Date();
            a3.lastModified = +a3.lastModifiedDate;
            return a3;
          }
          File2.isPolyfill = true;
          File2.prototype = create(Blob2.prototype);
          File2.prototype.constructor = File2;
          if (Object.setPrototypeOf) {
            Object.setPrototypeOf(File2, Blob2);
          } else {
            try {
              File2.__proto__ = Blob2;
            } catch (e2) {
            }
          }
          ...
          URL3.createObjectURL = function(blob2) {
            return blob2 instanceof Blob2 ? "data:" + blob2.type + ";base64," + array2base64(blob2._buffer) : createObjectURL.call(URL3, blob2);
          };
          URL3.createObjectURL.isPolyfill = true;
          URL3.revokeObjectURL = function(url) {
            revokeObjectURL && revokeObjectURL.call(URL3, url);
          };
          URL3.revokeObjectURL.isPolyfill = true;
          var _send = global2.XMLHttpRequest && global2.XMLHttpRequest.prototype.send;
          if (_send) {
            XMLHttpRequest.prototype.send = function(data) {
              if (data instanceof Blob2) {
        ...
        function fixFileAndXHR() {
          var isIE = !!global2.ActiveXObject || typeof document !== "undefined" && "-ms-scroll-limit" in document.documentElement.style && "-ms-ime-align" in document.documentElement.style;
          var _send = global2.XMLHttpRequest && global2.XMLHttpRequest.prototype.send;
          if (isIE && _send) {
            XMLHttpRequest.prototype.send = function(data) {
          ...
          try {
            ...
            try {
              ...
              exports2.File = function File2(b3, d2, c2) {
                var blob2 = new Blob(b3, c2);
                var t2 = c2 && void 0 !== c2.lastModified ? new Date(c2.lastModified) : /* @__PURE__ */ new Date();
                blob2.name = d2.replace(/\//g, ":");
                blob2.lastModifiedDate = t2;
                blob2.lastModified = +t2;
        ...
        function _read(fr2, blob2, kind) {
          if (!(blob2 instanceof exports2.Blob)) {
        ...
        FileReader.prototype.readAsDataURL = function(blob2) {
          _read(this, blob2, "readAsDataURL");
          this.result = "data:" + blob2.type + ";base64," + array2base64(blob2._buffer);
        };
        FileReader.prototype.readAsText = function(blob2) {
          _read(this, blob2, "readAsText");
          this.result = textDecode(blob2._buffer);
        };
        FileReader.prototype.readAsArrayBuffer = function(blob2) {
          _read(this, blob2, "readAsText");
          this.result = (blob2._buffer.buffer || blob2._buffer).slice();
        };
        FileReader.prototype.abort = function() {
        };
        exports2.FileReader = global2.FileReader || FileReader;
        exports2.URL = global2.URL || URL3;
        if (strTag) {
          if (!exports2.File.prototype[strTag]) exports2.File.prototype[strTag] = "File";
          if (!exports2.Blob.prototype[strTag]) exports2.Blob.prototype[strTag] = "Blob";
          if (!exports2.FileReader.prototype[strTag]) exports2.FileReader.prototype[strTag] = "FileReader";
        }
        var blob = exports2.Blob.prototype;
        var stream3;
        try {
          new ReadableStream({ type: "bytes" });
          stream3 = function stream4() {
            var position = 0;
            var blob2 = this;
          ...
          try {
            new ReadableStream({});
            stream3 = function stream4(blob2) {
              var position = 0;
              return new ReadableStream({
                pull: function(controller) {
        ...
        if (!blob.arrayBuffer) {
          blob.arrayBuffer = function arrayBuffer() {
            var fr2 = new exports2.FileReader();
            fr2.readAsArrayBuffer(this);
            return promisify(fr2);
          };
        }
        if (!blob.text) {
          blob.text = function text3() {
            var fr2 = new exports2.FileReader();
            fr2.readAsText(this);
            return promisify(fr2);
          };
...
// node_modules/.pnpm/formdata-polyfill@4.0.10/node_modules/formdata-polyfill/formdata.min.js
var formdata_min_exports = {};
var init_formdata_min = __esm({
  "node_modules/.pnpm/formdata-polyfill@4.0.10/node_modules/formdata-polyfill/formdata.min.js"() {
    (function() {
      var h2;
      function l2(a3) {
      ...
      var m2 = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a3, b3, c2) {
      ...
      function r2(a3, b3) {
        if (b3) a: {
          var c2 = q3;
          a3 = a3.split(".");
          for (var d2 = 0; d2 < a3.length - 1; d2++) {
            var e2 = a3[d2];
            if (!(e2 in c2)) break a;
            c2 = c2[e2];
          }
          ...
          d2 = c2[a3];
          b3 = b3(d2);
          b3 != d2 && null != b3 && m2(c2, a3, { configurable: true, writable: true, value: b3 });
        }
      }
      r2("Symbol", function(a3) {
        function b3(f2) {
        ...
        function c2(f2, g2) {
          this.A = f2;
          m2(this, "description", { configurable: true, writable: true, value: g2 });
        }
        if (a3) return a3;
      ...
      r2("Symbol.iterator", function(a3) {
        if (a3) return a3;
        ...
        for (var b3 = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c2 = 0; c2 < b3.length; c2++) {
          var d2 = q3[b3[c2]];
          "function" === typeof d2 && "function" != typeof d2.prototype[a3] && m2(d2.prototype, a3, { configurable: true, writable: true, value: function() {
            return u2(l2(this));
          } });
        }
        return a3;
      ...
      function v3(a3) {
        ...
        return b3 ? b3.call(a3) : { next: l2(a3) };
      }
      var w3;
      if ("function" == typeof Object.setPrototypeOf) w3 = Object.setPrototypeOf;
      else {
        var y2;
        a: {
          var z3 = { a: true }, A2 = {};
      ...
      function D3(a3) {
        if (a3.m) throw new TypeError("Generator is already running");
        a3.m = true;
      }
      C3.prototype.o = function(a3) {
        this.v = a3;
      };
      C3.prototype.s = function(a3) {
        this.l = { D: a3, F: true };
        this.h = this.C || this.u;
      };
      C3.prototype.return = function(a3) {
        this.l = { return: a3 };
        this.h = this.u;
      };
      function E2(a3, b3) {
      ...
      F3.prototype.o = function(a3) {
        D3(this.g);
        if (this.g.j) return G3(this, this.g.j.next, a3, this.g.o);
        this.g.o(a3);
        return H2(this);
      };
      function I3(a3, b3) {
        D3(a3.g);
        var c2 = a3.g.j;
        if (c2) return G3(a3, "return" in c2 ? c2["return"] : function(d2) {
          return { value: d2, done: true };
        }, b3, a3.g.return);
        a3.g.return(b3);
        return H2(a3);
      }
      F3.prototype.s = function(a3) {
        D3(this.g);
        if (this.g.j) return G3(this, this.g.j["throw"], a3, this.g.o);
        this.g.s(a3);
        return H2(this);
      };
      function G3(a3, b3, c2, d2) {
        try {
          var e2 = b3.call(a3.g.j, c2);
          if (!(e2 instanceof Object)) throw new TypeError("Iterator result " + e2 + " is not an object");
          if (!e2.done) return a3.g.m = false, e2;
          var f2 = e2.value;
        } catch (g2) {
          return a3.g.j = null, a3.g.s(g2), H2(a3);
        }
        a3.g.j = null;
        d2.call(a3.g, f2);
        return H2(a3);
      ...
      function H2(a3) {
        for (; a3.g.h; ) try {
          var b3 = a3.G(a3.g);
          if (b3) return a3.g.m = false, { value: b3.value, done: false };
        } catch (c2) {
          a3.g.v = void 0, a3.g.s(c2);
        }
        a3.g.m = false;
        if (a3.g.l) {
          b3 = a3.g.l;
      ...
      function K3(a3, b3) {
        b3 = new J3(new F3(b3));
        B3 && a3.prototype && B3(b3, a3.prototype);
        return b3;
      }
      function L3(a3, b3) {
        ...
        var c2 = 0, d2 = false, e2 = { next: function() {
          if (!d2 && c2 < a3.length) {
            var f2 = c2++;
            return { value: b3(f2, a3[f2]), done: false };
          }
          d2 = true;
      ...
      r2("Array.prototype.entries", function(a3) {
        return a3 ? a3 : function() {
          return L3(this, function(b3, c2) {
            return [b3, c2];
          });
        };
      });
      if ("undefined" !== typeof Blob && ("undefined" === typeof FormData || !FormData.prototype.keys)) {
        var M2 = function(a3, b3) {
          for (var c2 = 0; c2 < a3.length; c2++) b3(a3[c2]);
        }, N2 = function(a3) {
          return a3.replace(/\r?\n|\r/g, "\r\n");
        }, O3 = function(a3, b3, c2) {
          if (b3 instanceof Blob) {
            c2 = void 0 !== c2 ? String(c2 + "") : "string" === typeof b3.name ? b3.name : "blob";
            if (b3.name !== c2 || "[object Blob]" === Object.prototype.toString.call(b3)) b3 = new File([b3], c2);
            return [String(a3), b3];
          }
          return [String(a3), String(b3)];
        }, P3 = function(a3, b3) {
          if (a3.length < b3) throw new TypeError(b3 + " argument required, but only " + a3.length + " present.");
        }, Q3 = "object" === typeof globalThis ? globalThis : "object" === typeof window ? window : "object" === typeof self ? self : this, R3 = Q3.FormData, S2 = Q3.XMLHttpRequest && Q3.XMLHttpRequest.prototype.send, T3 = Q3.Request && Q3.fetch, U3 = Q3.navigator && Q3.navigator.sendBeacon, V3 = Q3.Element && Q3.Element.prototype, W3 = Q3.Symbol && Symbol.toStringTag;
        W3 && (Blob.prototype[W3] || (Blob.prototype[W3] = "Blob"), "File" in Q3 && !File.prototype[W3] && (File.prototype[W3] = "File"));
        try {
          new File([], "");
        } catch (a3) {
          Q3.File = function(b3, c2, d2) {
            b3 = new Blob(b3, d2 || {});
            Object.defineProperties(b3, { name: { value: c2 }, lastModified: { value: +(d2 && void 0 !== d2.lastModified ? new Date(d2.lastModified) : /* @__PURE__ */ new Date()) }, toString: { value: function() {
              return "[object File]";
            } } });
            W3 && Object.defineProperty(b3, W3, { value: "File" });
            return b3;
          };
        }
        var escape = function(a3) {
          return a3.replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22");
        }, X2 = function(a3) {
          this.i = [];
          var b3 = this;
          a3 && M2(a3.elements, function(c2) {
            if (c2.name && !c2.disabled && "submit" !== c2.type && "button" !== c2.type && !c2.matches("form fieldset[disabled] *")) if ("file" === c2.type) {
              var d2 = c2.files && c2.files.length ? c2.files : [new File([], "", { type: "application/octet-stream" })];
              M2(d2, function(e2) {
                b3.append(c2.name, e2);
              });
            } else "select-multiple" === c2.type || "select-one" === c2.type ? M2(c2.options, function(e2) {
              !e2.disabled && e2.selected && b3.append(c2.name, e2.value);
            }) : "checkbox" === c2.type || "radio" === c2.type ? c2.checked && b3.append(c2.name, c2.value) : (d2 = "textarea" === c2.type ? N2(c2.value) : c2.value, b3.append(c2.name, d2));
          });
        };
        h2 = X2.prototype;
        h2.append = function(a3, b3, c2) {
          P3(arguments, 2);
          this.i.push(O3(a3, b3, c2));
        };
        h2.delete = function(a3) {
          P3(
            arguments,
            1
          );
          var b3 = [];
          a3 = String(a3);
          M2(this.i, function(c2) {
            c2[0] !== a3 && b3.push(c2);
          });
          this.i = b3;
        };
        h2.entries = function b3() {
          var c2, d2 = this;
          return K3(b3, function(e2) {
            1 == e2.h && (c2 = 0);
            if (3 != e2.h) return c2 < d2.i.length ? e2 = E2(e2, d2.i[c2]) : (e2.h = 0, e2 = void 0), e2;
            c2++;
            e2.h = 2;
          });
        };
        h2.forEach = function(b3, c2) {
          P3(arguments, 1);
          for (var d2 = v3(this), e2 = d2.next(); !e2.done; e2 = d2.next()) {
            var f2 = v3(e2.value);
            e2 = f2.next().value;
            f2 = f2.next().value;
            b3.call(c2, f2, e2, this);
          }
        };
        h2.get = function(b3) {
          P3(arguments, 1);
          var c2 = this.i;
          b3 = String(b3);
          for (var d2 = 0; d2 < c2.length; d2++) if (c2[d2][0] === b3) return c2[d2][1];
          return null;
        };
        h2.getAll = function(b3) {
          P3(arguments, 1);
          var c2 = [];
          b3 = String(b3);
          M2(this.i, function(d2) {
            d2[0] === b3 && c2.push(d2[1]);
          });
          return c2;
        };
        h2.has = function(b3) {
          P3(arguments, 1);
          b3 = String(b3);
          for (var c2 = 0; c2 < this.i.length; c2++) if (this.i[c2][0] === b3) return true;
          return false;
        };
        h2.keys = function c2() {
          var d2 = this, e2, f2, g2, k2, p2;
          return K3(c2, function(t2) {
            1 == t2.h && (e2 = v3(d2), f2 = e2.next());
            if (3 != t2.h) {
              if (f2.done) {
                t2.h = 0;
                return;
        ...
        h2.set = function(c2, d2, e2) {
          ...
          M2(this.i, function(p2) {
            p2[0] === c2 ? k2 && (k2 = !f2.push(g2)) : f2.push(p2);
          });
          k2 && f2.push(g2);
          this.i = f2;
        };
        h2.values = function d2() {
          var e2 = this, f2, g2, k2, p2, t2;
          return K3(d2, function(x3) {
            1 == x3.h && (f2 = v3(e2), g2 = f2.next());
            if (3 != x3.h) {
              if (g2.done) {
                x3.h = 0;
                return;
        ...
        X2.prototype._asNative = function() {
          for (var d2 = new R3(), e2 = v3(this), f2 = e2.next(); !f2.done; f2 = e2.next()) {
            var g2 = v3(f2.value);
            f2 = g2.next().value;
            g2 = g2.next().value;
            d2.append(f2, g2);
        ...
        X2.prototype._blob = function() {
          var d2 = "----formdata-polyfill-" + Math.random(), e2 = [], f2 = "--" + d2 + '\r\nContent-Disposition: form-data; name="';
          this.forEach(function(g2, k2) {
            return "string" == typeof g2 ? e2.push(f2 + escape(N2(k2)) + ('"\r\n\r\n' + N2(g2) + "\r\n")) : e2.push(f2 + escape(N2(k2)) + ('"; filename="' + escape(g2.name) + '"\r\nContent-Type: ' + (g2.type || "application/octet-stream") + "\r\n\r\n"), g2, "\r\n");
          });
          e2.push("--" + d2 + "--");
          return new Blob(e2, { type: "multipart/form-data; boundary=" + d2 });
        };
        X2.prototype[Symbol.iterator] = function() {
          return this.entries();
        };
        X2.prototype.toString = function() {
          return "[object FormData]";
        };
        V3 && !V3.matches && (V3.matches = V3.matchesSelector || V3.mozMatchesSelector || V3.msMatchesSelector || V3.oMatchesSelector || V3.webkitMatchesSelector || function(d2) {
          d2 = (this.document || this.ownerDocument).querySelectorAll(d2);
          for (var e2 = d2.length; 0 <= --e2 && d2.item(e2) !== this; ) ;
          return -1 < e2;
        });
        W3 && (X2.prototype[W3] = "FormData");
        if (S2) {
          var Y3 = Q3.XMLHttpRequest.prototype.setRequestHeader;
          Q3.XMLHttpRequest.prototype.setRequestHeader = function(d2, e2) {
            Y3.call(this, d2, e2);
            "content-type" === d2.toLowerCase() && (this.B = true);
          };
          Q3.XMLHttpRequest.prototype.send = function(d2) {
            d2 instanceof X2 ? (d2 = d2._blob(), this.B || this.setRequestHeader("Content-Type", d2.type), S2.call(this, d2)) : S2.call(this, d2);
          };
        }
        T3 && (Q3.fetch = function(d2, e2) {
          e2 && e2.body && e2.body instanceof X2 && (e2.body = e2.body._blob());
          return T3.call(this, d2, e2);
        });
        U3 && (Q3.navigator.sendBeacon = function(d2, e2) {
          e2 instanceof X2 && (e2 = e2._asNative());
          return U3.call(this, d2, e2);
        });
        Q3.FormData = X2;
      }
      ;
...
// node_modules/.pnpm/abortcontroller-polyfill@1.7.8/node_modules/abortcontroller-polyfill/dist/umd-polyfill.js
var require_umd_polyfill = __commonJS({
  "node_modules/.pnpm/abortcontroller-polyfill@1.7.8/node_modules/abortcontroller-polyfill/dist/umd-polyfill.js"() {
    (function(factory) {
          ...
          value: function any(iterable) {
            ...
            function clean() {
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                  var signal4 = _step.value;
                  signal4.removeEventListener("abort", abort);
                }
              } catch (err) {
                _iterator.e(err);
              } finally {
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                var signal3 = _step2.value;
                if (signal3.aborted) {
                  controller.abort(signal3.reason);
                  break;
                } else signal3.addEventListener("abort", abort);
              }
            } catch (err) {
              _iterator2.e(err);
            } finally {
      ...
      function abortableFetchDecorator(patchTargets) {
        ...
        var abortableFetch = function abortableFetch2(input, init) {
          var signal3 = Request3 && Request3.prototype.isPrototypeOf(input) ? input.signal : init ? init.signal : void 0;
          if (signal3) {
            var abortError;
            try {
            ...
            var cancellation = new Promise(function(_3, reject) {
              signal3.addEventListener("abort", function() {
      ...
      (function(self2) {
        ...
        var _abortableFetch = abortableFetchDecorator(self2), fetch2 = _abortableFetch.fetch, Request3 = _abortableFetch.Request;
        self2.fetch = fetch2;
...
// node_modules/.pnpm/custom-event-polyfill@1.0.7/node_modules/custom-event-polyfill/polyfill.js
var require_polyfill = __commonJS({
  "node_modules/.pnpm/custom-event-polyfill@1.0.7/node_modules/custom-event-polyfill/polyfill.js"() {
    (function() {
      ...
      try {
        var ce3 = new window.CustomEvent("test", { cancelable: true });
        ce3.preventDefault();
        if (ce3.defaultPrevented !== true) {
...
function isValidHeaderName(value) {
  ...
  for (let i2 = 0; i2 < value.length; i2++) {
    const character = value.charCodeAt(i2);
...
function headersToObject(headers) {
  ...
  headers.forEach((value, name) => {
    ...
    headersObject[name] = isMultiValue ? value.split(",").map((s2) => s2.trim()) : value;
  });
...
var __create2, __defProp2, __getOwnPropDesc2, __getOwnPropNames2, __getProtoOf2, __hasOwnProp2, __commonJS2, __copyProps2, __toESM2, require_set_cookie, import_set_cookie_parser, HEADERS_INVALID_CHARACTERS, charCodesToRemove, HEADER_VALUE_REMOVE_REGEXP, NORMALIZED_HEADERS, RAW_HEADER_NAMES, HEADER_VALUE_DELIMITER, _a, _b, _c, Headers2, singleValueHeaders;
var init_lib = __esm({
  "node_modules/.pnpm/headers-polyfill@4.0.3/node_modules/headers-polyfill/lib/index.mjs"() {
    ...
    singleValueHeaders = ["user-agent"];
  }
});

// src/module/http/connection.ts
var streams, ssl, dns, os3, timers, asfs, Connection, ConnectionManager, connectionManager;
var init_connection = __esm({
  "src/module/http/connection.ts"() {
    "use strict";
    init_assert();
    streams = import.meta.use("streams");
    ssl = import.meta.use("ssl");
    dns = import.meta.use("dns");
    os3 = import.meta.use("os");
    timers = import.meta.use("timers");
    asfs = import.meta.use("asyncfs");
    Connection = class {
      socket;
      sslPipe = null;
      ...
      async connect() {
        try {
          const addresses = await dns.resolve(this.config.hostname, {
            family: os3.AF_UNSPEC
          });
          if (!addresses || addresses.length === 0) {
            throw new Error(`DNS resolution failed for ${this.config.hostname}`);
          }
          const addr = addresses.find((a3) => a3.family === 4) || addresses[0];
       ...
       */
      async findSystemCaPath() {
        const candidates = (() => {
          switch (os3.uname().sysname) {
            case "Linux":
              return [
        ...
        for (const p2 of candidates) {
          try {
            const st2 = await asfs.stat(p2);
            if (st2.isFile) return p2;
          } catch {
          }
        }
        return null;
      ...
      async setupSSL() {
        ...
        while (!this.sslPipe.handshakeComplete) {
          ...
          const n2 = await this.socket.read(readBuf);
          if (n2 === null || n2 === 0) {
            throw new Error("SSL handshake failed: connection closed");
          }
          this.sslPipe.feed(readBuf.slice(0, n2));
          this.sslPipe.doHandshake();
       ...
       * 读取数据
       */
      async read(size = 16384) {
        const buf = new Uint8Array(size);
        const n2 = await this.socket.read(buf);
        if (n2 === null || n2 === 0) {
          return null;
        }
        const data = buf.slice(0, n2);
        if (this.sslPipe) {
      ...
      startIdleTimer() {
        ...
        this.stopIdleTimer();
        const timeout = this.config.keepAliveTimeout || 5e3;
    ...
    ConnectionManager = class {
      ...
      async acquire(config) {
        ...
        const key = this.getKey(fullConfig);
        this.cleanupPool(key);
        const pool = this.pools.get(key) || [];
        const available = pool.find((conn2) => conn2.isAvailable());
        if (available) {
        ...
        if (pool.length >= maxSockets) {
          return this.waitForConnection(key, fullConfig);
        }
        const conn = new Connection(fullConfig);
        await conn.connect();
        conn.markActive();
        pool.push(conn);
       ...
       * 等待可用连接
       */
      async waitForConnection(key, config) {
      ...
      getStats() {
        ...
        for (const [key, pool] of this.pools.entries()) {
          const idle = pool.filter((c2) => c2.state === "idle" /* IDLE */).length;
          const active = pool.filter((c2) => c2.state === "active" /* ACTIVE */).length;
          stats[key] = {
            total: pool.length,
            idle,
            active
...
// src/module/http/base.ts
function isRedirect(statusCode) {
  return statusCode >= 300 && statusCode < 400;
}
var http, engine3, HttpRequestBuilder, HttpResponseParser;
var init_base = __esm({
  "src/module/http/base.ts"() {
    "use strict";
    init_lib();
    http = import.meta.use("http");
    ...
    HttpRequestBuilder = class {
      ...
      setBody(body) {
        if (body instanceof Uint8Array) {
          ...
          this.body = engine3.encodeString(body);
        } else if (body instanceof URLSearchParams) {
          this.body = engine3.encodeString(body.toString());
          ...
          this.body = engine3.encodeString(JSON.stringify(body));
          if (!this.headers.has("content-type")) {
...
`;
            if (typeof value === "string") {
              formBody += `Content-Disposition: form-data; name="${key}"\r
\r
`;
              formBody += `${value}\r
`;
              ...
              formBody += `Content-Disposition: form-data; name="${key}"; filename="${fileName}"\r
`;
              formBody += `Content-Type: ${value.type || "application/octet-stream"}\r
\r
`;
              const buffer = await value.arrayBuffer();
              formBody += engine3.decodeString(new Uint8Array(buffer)) + "\r\n";
            }
          }
          formBody += `--${boundary}--\r
`;
          this.body = engine3.encodeString(formBody);
      ...
      build() {
        ...
        const path2 = this.url.pathname + this.url.search;
        let request = `${this.method} ${path2} HTTP/1.1\r
`;
...
`;
        ...
        request += "\r\n";
        const headerBytes = engine3.encodeString(request);
        if (this.body) {
    ...
    HttpResponseParser = class {
      ...
      setupCallbacks() {
        this.parser.onStatus = (ev, buf, off, len) => {
          const view = new Uint8Array(buf).slice(off, off + len);
          this.statusText = engine3.decodeString(view);
        };
        this.parser.onHeaderField = (ev, buf, off, len) => {
          const view = new Uint8Array(buf).slice(off, off + len);
          this.currentHeaderField = engine3.decodeString(view).toLowerCase();
        };
        this.parser.onHeaderValue = (ev, buf, off, len) => {
          const view = new Uint8Array(buf).slice(off, off + len);
          const value = engine3.decodeString(view);
...
function createResponseBodyStream(ctx) {
  return new ReadableStream({
...
async function readHeaders(ctx) {
...
function releaseConnection(ctx) {
...
async function performFetch(request, url, redirectCount = 0) {
  ...
  try {
    ...
    const response = new Response2(bodyStream, {
      status: statusCode,
      statusText,
      headers
    });
...
async function handleRedirect(request, url, location, statusCode, redirectCount) {
  const redirectUrl = new URL(location, url);
  let redirectMethod = request.method;
  if (statusCode === 303 || (statusCode === 301 || statusCode === 302) && request.method === "POST") {
    redirectMethod = "GET";
  }
  const redirectRequest = new Request2(redirectUrl.toString(), {
    method: redirectMethod,
    headers: request.headers,
    body: redirectMethod === "GET" ? null : request._bodySource,
...
var engine4, Request2, Response2;
  ...
  "src/module/http/fetch.ts"() {
    ...
    Request2 = class _Request {
      ...
      constructor(input, init) {
        if (input instanceof URL) {
          ...
          this.headers = new Headers2(init?.headers || input.headers);
          ...
          start: async (controller) => {
            try {
              if (typeof bodySource === "string") {
                controller.enqueue(engine4.encodeString(bodySource));
                ...
                controller.enqueue(engine4.encodeString(bodySource.toString()));
              } else if (bodySource instanceof FormData) {
                throw new Error("FormData not yet implemented");
              } else {
                controller.enqueue(engine4.encodeString(JSON.stringify(bodySource)));
              }
              controller.close();
            } catch (err) {
              controller.error(err);
      ...
      async text() {
        const buffer = await this.arrayBuffer();
        return engine4.decodeString(new Uint8Array(buffer));
      }
      json() {
    ...
    Response2 = class _Response {
      ...
      constructor(body, init) {
        ...
        this.body = body !== void 0 && body !== null ? this.createBodyStream(body) : null;
      }
      createBodyStream(bodyInit) {
          ...
          start: async (controller) => {
            try {
              if (typeof bodyInit === "string") {
                controller.enqueue(engine4.encodeString(bodyInit));
                ...
                controller.enqueue(engine4.encodeString(bodyInit.toString()));
              } else if (bodyInit instanceof FormData) {
                throw new Error("FormData not yet implemented");
              } else {
                controller.enqueue(engine4.encodeString(JSON.stringify(bodyInit)));
              }
              controller.close();
            } catch (err) {
              controller.error(err);
      ...
      clone() {
        ...
        const response = new _Response(this._bodyBuffer, {
          status: this.status,
      ...
      static redirect(url, status = 302) {
        ...
        const response = new _Response(null, {
          status,
      ...
      static json(data, init) {
        ...
        const headers = new Headers2(init?.headers);
        if (!headers.has("content-type")) {
          headers.set("content-type", "application/json");
        }
        return new _Response(body, { ...init, headers });
      }
    };
    Reflect.set(globalThis, "fetch", fetch);
    Reflect.set(globalThis, "Response", Response2);
    Reflect.set(globalThis, "Request", Request2);
  }
});

// src/module/http/websocket.ts
...
__export(websocket_exports, {
  ...
  createWebSocketFromConnection: () => createWebSocketFromConnection
});
function createWebSocketFromConnection(connection) {
  return new WebSocket(connection, true);
}
var crypto2, engine5, timers2, OpCode, WebSocketReadyState, WebSocketCloseCode, WebSocket;
var init_websocket = __esm({
  "src/module/http/websocket.ts"() {
    ...
    init_base();
    init_lib();
    crypto2 = import.meta.use("crypto");
    engine5 = import.meta.use("engine");
    timers2 = import.meta.use("timers");
    OpCode = /* @__PURE__ */ ((OpCode2) => {
      OpCode2[OpCode2["CONTINUATION"] = 0] = "CONTINUATION";
      OpCode2[OpCode2["TEXT"] = 1] = "TEXT";
      OpCode2[OpCode2["BINARY"] = 2] = "BINARY";
      OpCode2[OpCode2["CLOSE"] = 8] = "CLOSE";
      OpCode2[OpCode2["PING"] = 9] = "PING";
      OpCode2[OpCode2["PONG"] = 10] = "PONG";
      return OpCode2;
    })(OpCode || {});
    WebSocketReadyState = /* @__PURE__ */ ((WebSocketReadyState2) => {
    ...
    WebSocketCloseCode = /* @__PURE__ */ ((WebSocketCloseCode2) => {
      WebSocketCloseCode2[WebSocketCloseCode2["NORMAL"] = 1e3] = "NORMAL";
      ...
      WebSocketCloseCode2[WebSocketCloseCode2["NO_STATUS"] = 1005] = "NO_STATUS";
      WebSocketCloseCode2[WebSocketCloseCode2["ABNORMAL"] = 1006] = "ABNORMAL";
      WebSocketCloseCode2[WebSocketCloseCode2["INVALID_PAYLOAD"] = 1007] = "INVALID_PAYLOAD";
      ...
      WebSocketCloseCode2[WebSocketCloseCode2["EXTENSION_REQUIRED"] = 1010] = "EXTENSION_REQUIRED";
      ...
      WebSocketCloseCode2[WebSocketCloseCode2["TLS_HANDSHAKE_FAIL"] = 1015] = "TLS_HANDSHAKE_FAIL";
      return WebSocketCloseCode2;
    })(WebSocketCloseCode || {});
    WebSocket = class extends EventTarget {
      // 常量
      static CONNECTING = 0 /* CONNECTING */;
      static OPEN = 1 /* OPEN */;
      static CLOSING = 2 /* CLOSING */;
      static CLOSED = 3 /* CLOSED */;
      ...
      onerror = null;
      onclose = null;
      constructor(urlOrConnection, protocolsOrIsServer) {
        super();
        if (typeof urlOrConnection === "string") {
          this.url = urlOrConnection;
          this.isClient = true;
          const protocols = protocolsOrIsServer;
          if (protocols) {
      ...
      generateWebSocketKey() {
        ...
        return crypto2.base64Encode(random);
      }
      /**
       * 开始接收数据
       */
      async startReceiving() {
        try {
          while (this._readyState === 1 /* OPEN */ && this.connection) {
            const data = await this.connection.read();
            if (!data || data.length === 0) {
              this.handleClose(1006 /* ABNORMAL */, "Connection closed");
              break;
            }
          ...
          if (this._readyState !== 3 /* CLOSED */) {
            this.emitError(err);
            this.close(1006 /* ABNORMAL */, "Read error");
          }
        }
      }
      /**
        ...
        switch (frame.opcode) {
          ...
          case 0 /* CONTINUATION */:
            if (this.fragmentOpcode === null) {
              this.close(1002 /* PROTOCOL_ERROR */, "Unexpected continuation frame");
              return;
            }
            this.fragments.push(frame.payload);
            if (frame.fin) {
              const totalLength = this.fragments.reduce((sum, f2) => sum + f2.length, 0);
          ...
          case 10 /* PONG */:
            ...
            break;
          default:
            this.close(1002 /* PROTOCOL_ERROR */, "Unknown opcode");
        }
      }
      /**
       * 发送消息
       */
      send(data) {
        if (this._readyState !== 1 /* OPEN */) {
          throw new Error("WebSocket is not open");
        }
        if (typeof data === "string") {
          const payload = engine5.encodeString(data);
          this.sendFrame(1 /* TEXT */, payload, true);
        } else if (data instanceof Blob) {
          data.arrayBuffer().then((buffer) => {
            const payload = new Uint8Array(buffer);
            this.sendFrame(2 /* BINARY */, payload, true);
          });
        } else {
       ...
       * 发送帧
       */
      async sendFrame(opcode, payload, fin = true) {
        ...
        try {
          ...
          this.emitError(err);
          this.close(1006 /* ABNORMAL */, "Write error");
        }
      }
      /**
       * 构建帧
       */
      buildFrame(opcode, payload, fin, masked) {
        ...
        let offset = 0;
        frame[offset++] = (fin ? 128 : 0) | opcode;
        let byte2 = masked ? 128 : 0;
        if (payloadLength <= 125) {
          ...
          byte2 |= 126;
          frame[offset++] = byte2;
          frame[offset++] = payloadLength >> 8 & 255;
          frame[offset++] = payloadLength & 255;
        } else {
          byte2 |= 127;
          frame[offset++] = byte2;
          frame[offset++] = 0;
          ...
          frame[offset++] = 0;
          frame[offset++] = 0;
          frame[offset++] = payloadLength >> 24 & 255;
          frame[offset++] = payloadLength >> 16 & 255;
          frame[offset++] = payloadLength >> 8 & 255;
          frame[offset++] = payloadLength & 255;
        }
        if (masked) {
          const maskKey = new Uint8Array(crypto2.randomBytes(4));
      ...
      mask(data, maskKey) {
        ...
        for (let i2 = 0; i2 < data.length; i2++) {
          masked[i2] = data[i2] ^ maskKey[i2 % 4];
        }
        return masked;
      }
      /**
       ...
       */
      unmask(data, maskKey) {
        return this.mask(data, maskKey);
      }
      /**
       * 关闭连接
       */
      close(code = 1e3 /* NORMAL */, reason = "") {
        if (this._readyState === 2 /* CLOSING */ || this._readyState === 3 /* CLOSED */) {
          return;
        }
        this._readyState = 2 /* CLOSING */;
        const payload = new Uint8Array(2 + engine5.encodeString(reason).length);
        payload[0] = code >> 8 & 255;
        payload[1] = code & 255;
        if (reason) {
          payload.set(engine5.encodeString(reason), 2);
        }
        this.sendFrame(8 /* CLOSE */, payload, true).then(() => {
          timers2.setTimeout(() => {
      ...
      handleCloseFrame(payload) {
        let code = 1005 /* NO_STATUS */;
        let reason = "";
        if (payload.length >= 2) {
          code = payload[0] << 8 | payload[1];
          if (payload.length > 2) {
            reason = engine5.decodeString(payload.slice(2));
          }
        }
        if (this._readyState === 1 /* OPEN */) {
          const response = new Uint8Array(2);
          response[0] = code >> 8 & 255;
          response[1] = code & 255;
          this.sendFrame(8 /* CLOSE */, response, true);
        }
        this.handleClose(code, reason);
      }
      /**
      ...
      handleClose(code, reason) {
        if (this._readyState === 3 /* CLOSED */) return;
        this._readyState = 3 /* CLOSED */;
        this.closeCode = code;
      ...
      sendPing() {
        if (this._readyState === 1 /* OPEN */) {
          this.sendFrame(9 /* PING */, new Uint8Array(0), true);
          this.pongTimeout = timers2.setTimeout(() => {
            this.close(1006 /* ABNORMAL */, "Ping timeout");
          }, 5e3);
        }
      }
      /**
      ...
      sendPong(payload) {
        if (this._readyState === 1 /* OPEN */) {
          this.sendFrame(10 /* PONG */, payload, true);
        }
      }
      /**
       * 处理 Pong
      ...
      handlePong() {
        if (this.pongTimeout !== null) {
          timers2.clearTimeout(this.pongTimeout);
       ...
       */
      startPingTimer() {
        this.pingInterval = timers2.setInterval(() => {
          this.sendPing();
        }, 3e4);
      }
      /**
      ...
      stopPingTimer() {
        if (this.pingInterval !== null) {
          timers2.clearInterval(this.pingInterval);
      ...
      emitMessage(opcode, payload) {
        let data;
        if (opcode === 1 /* TEXT */) {
          data = engine5.decodeString(payload);
        } else {
          data = this.binaryType === "arraybuffer" ? payload.buffer.slice(payload.byteOffset, payload.byteOffset + payload.byteLength) : new Blob([payload]);
        }
...
function toArrayBuffer(source) {
  ...
  const v3 = source.buffer.slice(source.byteOffset, source.byteOffset + source.byteLength);
  if (v3 instanceof ArrayBuffer) return v3;
...
function getHashFunction(algorithm) {
  ...
  const hashFunctions = {
    "SHA-1": crypto3.sha1,
    "SHA-256": crypto3.sha256,
    "SHA-384": crypto3.sha384,
    "SHA-512": crypto3.sha512,
    "SHA3-224": crypto3.sha3_224,
    "SHA3-256": crypto3.sha3_256,
    "SHA3-384": crypto3.sha3_384,
    "SHA3-512": crypto3.sha3_512
  };
  const fn = hashFunctions[normalized];
  if (!fn) throw new Error(`Unsupported hash algorithm: ${normalized}`);
  return fn;
}
function getHashOutputLength(algorithm) {
  const normalized = typeof algorithm === "string" ? algorithm.toUpperCase() : normalizeAlgorithm(algorithm).name;
  const lengths = {
    "SHA-1": 20,
    "SHA-256": 32,
...
var crypto3, CryptoKeyImpl, SubtleCrypto, subtle, webCrypto;
var init_crypto = __esm({
  "src/webapi/crypto.ts"() {
    "use strict";
    crypto3 = import.meta.use("crypto");
    CryptoKeyImpl = class {
    ...
    SubtleCrypto = class {
      ...
      async generateKey(algorithm, extractable, keyUsages) {
        ...
        if (alg.name === "RSASSA-PKCS1-V1_5" || alg.name === "RSA-PSS" || alg.name === "RSA-OAEP") {
          ...
          const keyPair = crypto3.generateRsaKey(params.modulusLength || 2048);
          const hashAlg = normalizeAlgorithm(params.hash);
          const algorithmObj = {
            name: alg.name,
            modulusLength: params.modulusLength || 2048,
            publicExponent: params.publicExponent || new Uint8Array([1, 0, 1]),
            hash: { name: hashAlg.name }
          };
          return {
            publicKey: new CryptoKeyImpl(
              "public",
              true,
              algorithmObj,
              keyUsages.filter((u2) => u2 === "verify" || u2 === "encrypt" || u2 === "wrapKey"),
              keyPair.publicKey
            ),
            privateKey: new CryptoKeyImpl(
              "private",
              extractable,
              algorithmObj,
              keyUsages.filter((u2) => u2 === "sign" || u2 === "decrypt" || u2 === "unwrapKey"),
              keyPair.privateKey
            )
          };
        }
        if (alg.name === "ECDSA" || alg.name === "ECDH") {
          ...
          let keyPair;
          if (curve === "P-256") keyPair = crypto3.generateEcKeyP256();
          else if (curve === "P-384") keyPair = crypto3.generateEcKeyP384();
          else if (curve === "P-521") keyPair = crypto3.generateEcKeyP521();
          ...
          return {
            publicKey: new CryptoKeyImpl(
              ...
              true,
              algorithmObj,
              keyUsages.filter((u2) => publicUsages.includes(u2)),
              keyPair.publicKey
            ),
            privateKey: new CryptoKeyImpl(
              "private",
              extractable,
              algorithmObj,
              keyUsages.filter((u2) => privateUsages.includes(u2)),
              keyPair.privateKey
            )
          };
        }
        if (alg.name === "AES-CBC" || alg.name === "AES-GCM") {
          ...
          const keyData = crypto3.randomBytes(length / 8);
          const algorithmObj = {
            name: alg.name,
            length
          };
      ...
      async sign(algorithm, key, data) {
        ...
        if (alg.name === "RSA-PSS") {
          ...
          if (keyAlg.hash.name === "SHA-256") {
            return crypto3.rsaPssSha256Sign(keyImpl._handle, dataBuffer, params.saltLength);
          }
        ...
        if (alg.name === "RSASSA-PKCS1-V1_5") {
          const keyAlg = keyImpl.algorithm;
          if (keyAlg.hash.name === "SHA-256") {
            return crypto3.signSha256(keyImpl._handle, dataBuffer);
          }
          if (keyAlg.hash.name === "SHA-512") {
            return crypto3.signSha512(keyImpl._handle, dataBuffer);
          }
        ...
        if (alg.name === "ECDSA") {
          ...
          if (keyAlg.namedCurve === "P-256") {
            return crypto3.ecdsaSignP256(keyImpl._handle, dataBuffer);
          }
          if (keyAlg.namedCurve === "P-384") {
            return crypto3.ecdsaSignP384(keyImpl._handle, dataBuffer);
          }
          if (keyAlg.namedCurve === "P-521") {
            return crypto3.ecdsaSignP521(keyImpl._handle, dataBuffer);
          }
        ...
        if (alg.name === "HMAC") {
          const keyAlg = keyImpl.algorithm;
          if (keyAlg.hash.name === "SHA-256") {
            return crypto3.hmacSha256(keyImpl._handle, dataBuffer);
          }
          if (keyAlg.hash.name === "SHA-512") {
            return crypto3.hmacSha512(keyImpl._handle, dataBuffer);
          }
          if (keyAlg.hash.name === "SHA-1") {
            return crypto3.hmacSha1(keyImpl._handle, dataBuffer);
          }
      ...
      async verify(algorithm, key, signature, data) {
        ...
        if (alg.name === "RSA-PSS") {
          ...
          const keyAlg = keyImpl.algorithm;
          if (keyAlg.hash.name === "SHA-256") {
            return crypto3.rsaPssSha256Verify(keyImpl._handle, dataBuffer, signatureBuffer, params.saltLength);
          }
          throw new Error(`Unsupported hash for RSA-PSS: ${keyAlg.hash.name}`);
        }
        if (alg.name === "RSASSA-PKCS1-V1_5") {
          const keyAlg = keyImpl.algorithm;
          if (keyAlg.hash.name === "SHA-256") {
            return crypto3.verifySha256(keyImpl._handle, dataBuffer, signatureBuffer);
          }
          if (keyAlg.hash.name === "SHA-512") {
            return crypto3.verifySha512(keyImpl._handle, dataBuffer, signatureBuffer);
          }
          throw new Error(`Unsupported hash for RSASSA-PKCS1-v1_5: ${keyAlg.hash.name}`);
        }
        if (alg.name === "ECDSA") {
          const keyAlg = keyImpl.algorithm;
          if (keyAlg.namedCurve === "P-256") {
            return crypto3.ecdsaVerifyP256(keyImpl._handle, dataBuffer, signatureBuffer);
          }
          if (keyAlg.namedCurve === "P-384") {
            return crypto3.ecdsaVerifyP384(keyImpl._handle, dataBuffer, signatureBuffer);
          }
          if (keyAlg.namedCurve === "P-521") {
            return crypto3.ecdsaVerifyP521(keyImpl._handle, dataBuffer, signatureBuffer);
          }
          throw new Error(`Unsupported curve for ECDSA: ${keyAlg.namedCurve}`);
        }
      ...
      async encrypt(algorithm, key, data) {
        ...
        if (alg.name === "RSA-OAEP") {
          const params = algorithm;
          const keyAlg = keyImpl.algorithm;
          const label = params.label ? toArrayBuffer(params.label) : void 0;
          if (keyAlg.hash.name === "SHA-256") {
            return crypto3.rsaOaepSha256Encrypt(keyImpl._handle, dataBuffer, label);
          }
          if (keyAlg.hash.name === "SHA-512") {
            return crypto3.rsaOaepSha512Encrypt(keyImpl._handle, dataBuffer, label);
          }
        ...
        if (alg.name === "AES-CBC") {
          ...
          if (keyAlg.length === 128) {
            return crypto3.aes128CbcEncrypt(keyImpl._handle, iv, dataBuffer);
          }
          if (keyAlg.length === 256) {
            return crypto3.aes256CbcEncrypt(keyImpl._handle, iv, dataBuffer);
          }
        ...
        if (alg.name === "AES-GCM") {
          ...
          const keyAlg = keyImpl.algorithm;
          const iv = toArrayBuffer(params.iv);
          const aad = params.additionalData ? toArrayBuffer(params.additionalData) : void 0;
          if (keyAlg.length === 128) {
            return crypto3.aes128GcmEncrypt(keyImpl._handle, iv, dataBuffer);
          }
          if (keyAlg.length === 256) {
            return crypto3.aes256GcmEncrypt(keyImpl._handle, iv, dataBuffer);
          }
          throw new Error(`Unsupported AES key length: ${keyAlg.length}`);
        }
      ...
      async decrypt(algorithm, key, data) {
        ...
        if (alg.name === "RSA-OAEP") {
          ...
          const label = params.label ? toArrayBuffer(params.label) : void 0;
          if (keyAlg.hash.name === "SHA-256") {
            return crypto3.rsaOaepSha256Decrypt(keyImpl._handle, dataBuffer, label);
          }
          if (keyAlg.hash.name === "SHA-512") {
            return crypto3.rsaOaepSha512Decrypt(keyImpl._handle, dataBuffer, label);
          }
          throw new Error(`Unsupported hash for RSA-OAEP: ${keyAlg.hash.name}`);
        }
        if (alg.name === "AES-CBC") {
          ...
          const iv = toArrayBuffer(params.iv);
          if (keyAlg.length === 128) {
            return crypto3.aes128CbcDecrypt(keyImpl._handle, iv, dataBuffer);
          }
          if (keyAlg.length === 256) {
            return crypto3.aes256CbcDecrypt(keyImpl._handle, iv, dataBuffer);
          }
          throw new Error(`Unsupported AES key length: ${keyAlg.length}`);
        }
        if (alg.name === "AES-GCM") {
          ...
          const iv = toArrayBuffer(params.iv);
          if (keyAlg.length === 128) {
            return crypto3.aes128GcmDecrypt(keyImpl._handle, iv, dataBuffer);
          }
          if (keyAlg.length === 256) {
            return crypto3.aes256GcmDecrypt(keyImpl._handle, iv, dataBuffer);
          }
          throw new Error(`Unsupported AES key length: ${keyAlg.length}`);
        }
      ...
      async deriveBits(algorithm, baseKey, length) {
        ...
        const alg = normalizeAlgorithm(algorithm);
        const keyImpl = baseKey;
        if (alg.name === "ECDH") {
          const params = algorithm;
          const keyAlg = keyImpl.algorithm;
          const publicKeyImpl = params.public;
          let sharedSecret;
          if (keyAlg.namedCurve === "P-256") {
            sharedSecret = crypto3.ecdhDeriveP256(keyImpl._handle, publicKeyImpl._handle);
          } else if (keyAlg.namedCurve === "P-384") {
            sharedSecret = crypto3.ecdhDeriveP384(keyImpl._handle, publicKeyImpl._handle);
          } else if (keyAlg.namedCurve === "P-521") {
            sharedSecret = crypto3.ecdhDeriveP521(keyImpl._handle, publicKeyImpl._handle);
          } else {
        ...
        if (alg.name === "HKDF") {
          ...
          if (hashAlg.name === "SHA-256") {
            return crypto3.hkdfSha256(keyImpl._handle, length / 8, salt, info);
          }
          if (hashAlg.name === "SHA-512") {
            return crypto3.hkdfSha512(keyImpl._handle, length / 8, salt, info);
          }
        ...
        if (alg.name === "PBKDF2") {
          ...
          const hashAlg = normalizeAlgorithm(params.hash);
          if (hashAlg.name === "SHA-256") {
            return crypto3.pbkdf2Sha256(keyImpl._handle, salt, params.iterations, length / 8);
          }
          if (hashAlg.name === "SHA-512") {
            return crypto3.pbkdf2Sha512(keyImpl._handle, salt, params.iterations, length / 8);
          }
      ...
      async wrapKey(format, key, wrappingKey, wrapAlgorithm) {
        ...
        return this.encrypt(wrapAlgorithm, wrappingKey, new Uint8Array(exportedKey));
      }
      /**
    ...
    webCrypto = {
      ...
      getRandomValues(buffer) {
        ...
        const bytes = crypto3.randomBytes(buffer.byteLength);
        new Uint8Array(buffer.buffer, buffer.byteOffset, buffer.byteLength).set(new Uint8Array(bytes));
        return buffer;
      },
      randomUUID() {
        const data = crypto3.randomBytes(16);
        const dv = new DataView(data);
        dv.setUint8(6, dv.getUint8(6) & 15 | 64);
        dv.setUint8(8, dv.getUint8(8) & 63 | 128);
        const hex = crypto3.hexEncode(data);
...
// src/webapi/performance.ts
var performance_exports = {};
__export(performance_exports, {
  installUserTimingPolyfill: () => installUserTimingPolyfill
});
function getStore(perf) {
  if (!storage.has(perf)) {
    storage.set(perf, {
      buffer: [],
...
function isMeasureOptions(obj) {
  return obj && typeof obj === "object" && ("start" in obj || "end" in obj || "duration" in obj);
}
function installUserTimingPolyfill() {
  if (performance.userTimingPolyfill) return;
  const original = {
  ...
  performance.measure = function(measureName, startOrMeasureOptions, endMark) {
    ...
    let endTime;
    let detail = null;
    if (typeof startOrMeasureOptions === "string" && endMark !== void 0) {
      ...
      detail = opts.detail;
      const hasStart = opts.start !== void 0;
      const hasEnd = opts.end !== void 0;
      const hasDuration = opts.duration !== void 0;
  ...
  performance.clearMarks = function(markName) {
    const store = getStore(this);
    if (markName === void 0) {
      store.buffer = store.buffer.filter((e2) => e2.entryType !== "mark");
      store.marks.clear();
    } else {
      store.buffer = store.buffer.filter(
        (e2) => !(e2.entryType === "mark" && e2.name === markName)
      );
  ...
  performance.clearMeasures = function(measureName) {
    ...
    if (measureName === void 0) {
      store.buffer = store.buffer.filter((e2) => e2.entryType !== "measure");
    } else {
      store.buffer = store.buffer.filter(
        (e2) => !(e2.entryType === "measure" && e2.name === measureName)
      );
    }
  };
  performance.getEntriesByType = function(type) {
    const store = getStore(this);
    const ourEntries = store.buffer.filter((e2) => e2.entryType === type);
    const nativeEntries = original.getEntriesByType ? original.getEntriesByType(type) : [];
    return [...ourEntries, ...nativeEntries];
  };
  performance.getEntriesByName = function(name, type) {
    const store = getStore(this);
    let ourEntries = store.buffer.filter((e2) => e2.name === name);
    if (type) {
      ourEntries = ourEntries.filter((e2) => e2.entryType === type);
    }
    const nativeEntries = original.getEntriesByName ? original.getEntriesByName(name, type) : [];
    return [...ourEntries, ...nativeEntries];
  };
  performance.getEntries = function() {
    const store = getStore(this);
    const nativeEntries = original.getEntries ? original.getEntries() : [];
    return [...store.buffer, ...nativeEntries];
  };
  performance.userTimingPolyfill = true;
}
var storage, PerformanceMark, PerformanceMeasure;
  ...
  "src/webapi/performance.ts"() {
    ...
    PerformanceMark = class {
      ...
      constructor(markName, markOptions = {}) {
        ...
        this.name = markName;
        this.startTime = markOptions.startTime !== void 0 ? Number(markOptions.startTime) : performance.now();
        if (this.startTime < 0) throw new TypeError("startTime cannot be negative");
        this.detail = markOptions.detail !== void 0 ? JSON.parse(JSON.stringify(markOptions.detail)) : null;
        Object.freeze(this);
      }
      toJSON() {
        return {
    ...
    PerformanceMeasure = class {
      ...
      duration;
      detail;
      constructor(measureName, startTime, duration, detail = null) {
...
var wasm, Module, Instance, Memory, Table, Global, CompileError, LinkError, RuntimeError, WebAssemblyPolyfill;
var init_wasm = __esm({
  "src/webapi/wasm.ts"() {
    "use strict";
    wasm = import.meta.use("wasm");
    Module = class {
      #native;
      constructor(bytes) {
        try {
      ...
      static imports(_module) {
        return [];
      }
      static customSections(_module, _sectionName) {
        return [];
      }
      get _native() {
        return this.#native;
    ...
    Instance = class {
      #native;
      #exports;
      constructor(module, _importObject) {
        try {
    ...
    Memory = class {
      ...
      grow(delta) {
        ...
        if (this.#maximum !== void 0 && newPages > this.#maximum) {
    ...
    Table = class {
      ...
      grow(delta, value) {
        ...
        if (this.#maximum !== void 0 && newLength > this.#maximum) {
    ...
    CompileError = globalThis.WebAssembly?.CompileError ?? class CompileError2 extends Error {
      constructor(message) {
        super(message);
        this.name = "CompileError";
      }
    };
    LinkError = globalThis.WebAssembly?.LinkError ?? class LinkError2 extends Error {
      constructor(message) {
        super(message);
        this.name = "LinkError";
      }
    };
    RuntimeError = globalThis.WebAssembly?.RuntimeError ?? class RuntimeError2 extends Error {
      constructor(message) {
        super(message);
...
// src/webapi/storage.ts
var storage_exports = {};
__export(storage_exports, {
  closeAllStorages: () => closeAllStorages,
  createStorage: () => createStorage,
  getLocalStorage: () => getLocalStorage,
  getSessionStorage: () => getSessionStorage
});
function getLocalStorage(path2) {
  return storageManager.getStorage("localStorage", path2);
}
function getSessionStorage(path2) {
  return storageManager.getStorage("sessionStorage", path2);
}
function createStorage(name, options) {
  const path2 = options?.path || storageManager["getDefaultPath"](name);
  return new Storage({
    name,
    path: path2,
    ...options
...
function closeAllStorages() {
  storageManager.closeAll();
}
function StorageCtor() {
  throw new Error("Storage is not constructable.");
}
var sqlite3, fs3, os4, crypto4, engine6, StorageEvent, Storage, StorageManager, storageManager;
var init_storage = __esm({
  "src/webapi/storage.ts"() {
    ...
    os4 = import.meta.use("os");
    crypto4 = import.meta.use("crypto");
    engine6 = import.meta.use("engine");
    ...
    Storage = class _Storage {
      ...
      static STMT_GET = "get";
      static STMT_SET = "set";
      static STMT_DELETE = "delete";
      static STMT_CLEAR = "clear";
      static STMT_KEYS = "keys";
      static STMT_COUNT = "count";
      static STMT_SIZE = "size";
      constructor(options) {
        this.options = {
          name: "default",
          debug: false,
        ...
        this.db = options?.path ? sqlite3.open(this.options.path, sqlite3.SQLITE_OPEN_READWRITE | sqlite3.SQLITE_OPEN_CREATE) : sqlite3.open(":memory:", sqlite3.SQLITE_OPEN_READWRITE | sqlite3.SQLITE_OPEN_CREATE | sqlite3.SQLITE_OPEN_MEMORY | sqlite3.SQLITE_OPEN_NOMUTEX);
        this.openDatabase();
      ...
      mkdirRecursive(path2) {
        const parts = path2.split("/").filter((p2) => p2);
        let current = path2.startsWith("/") ? "/" : "";
        for (const part of parts) {
          current += part;
          if (!fs3.exists(current)) {
            fs3.mkdir(current, 493);
          }
          current += "/";
        }
      }
      ...
      openDatabase() {
        ...
        const flags = sqlite3.SQLITE_OPEN_READWRITE | sqlite3.SQLITE_OPEN_CREATE;
        ...
        sqlite3.exec(this.db, "PRAGMA cache_size=-2000;");
    ...
    `);
        ...
        if (listeners) {
          for (const listener of listeners) {
            try {
              ...
              console.error("Error in storage event listener:", e2);
            }
          }
        }
      }
      ...
      checkQuota(additionalSize) {
        ...
        const stmt = this.stmtCache.get(_Storage.STMT_SIZE);
        const result = sqlite3.stmt_all(stmt, []);
        const currentSize = result[0].total;
      ...
      get length() {
        try {
          const stmt = this.stmtCache.get(_Storage.STMT_COUNT);
          const result = sqlite3.stmt_all(stmt, []);
      ...
      getItem(key) {
        try {
          const stmt = this.stmtCache.get(_Storage.STMT_GET);
      ...
      setItem(key, value) {
        try {
          ...
          const size = stringValue.length * 2;
          const now = Date.now();
          ...
          const stmt = this.stmtCache.get(_Storage.STMT_SET);
      ...
      removeItem(key) {
        try {
          ...
          const stmt = this.stmtCache.get(_Storage.STMT_DELETE);
      ...
      clear() {
        try {
          const stmt = this.stmtCache.get(_Storage.STMT_CLEAR);
      ...
      key(index) {
        try {
          ...
          const stmt = this.stmtCache.get(_Storage.STMT_KEYS);
          const result = sqlite3.stmt_all(stmt, []);
      ...
      entries() {
        try {
          ...
          const result = sqlite3.stmt_all(stmt, []);
          sqlite3.stmt_finalize(stmt);
          return result.map((row) => [row.key, row.value]);
        } catch (error) {
      ...
      getStats() {
        try {
          const countStmt = this.stmtCache.get(_Storage.STMT_COUNT);
          const sizeStmt = this.stmtCache.get(_Storage.STMT_SIZE);
          const countResult = sqlite3.stmt_all(countStmt, []);
          const sizeResult = sqlite3.stmt_all(sizeStmt, []);
          const count = countResult[0].count;
          const totalSize = sizeResult[0].total;
    ...
    StorageManager = class {
       ...
       */
      getStorage(name, path2, options) {
        if (this.storages.has(name)) {
          return this.storages.get(name);
        }
        const storagePath = path2 || this.getDefaultPath(name);
        ...
        this.storages.set(name, storage2);
        return storage2;
      }
      /**
       ...
       */
      getDefaultPath(name) {
        const hash = crypto4.base64Encode(crypto4.md5(engine6.encodeString(os4.cwd)));
        let path2;
        try {
          const homeDir = os4.getenv("HOME") ?? os4.cwd;
          path2 = `${homeDir}/.storage/${hash}/${name}.db`;
        } catch {
          path2 = `${os4.tmpdir}/.storage/${hash}/${name}.db`;
        }
        return path2;
      }
      /**
       ...
       */
      closeStorage(name) {
        const storage2 = this.storages.get(name);
        if (storage2) {
          storage2.close();
       ...
       */
      closeAll() {
        for (const [name, storage2] of this.storages) {
          storage2.close();
        }
        this.storages.clear();
      }
...
// src/webapi/index.ts
var webapi_exports = {};
var onEvent, URL2, URLSearchParams2, stream, globalEvent, Headers3;
var init_webapi = __esm({
  async "src/webapi/index.ts"() {
    "use strict";
    init_assert();
    ({ onEvent } = import.meta.use("engine"));
    ...
    ({ URL: URL2, URLSearchParams: URLSearchParams2 } = require_whatwg_url());
    Reflect.set(globalThis, "URL", URL2);
    Reflect.set(globalThis, "URLSearchParams", URLSearchParams2);
    await Promise.resolve().then(() => (init_urlpattern_polyfill(), urlpattern_polyfill_exports));
    stream = await Promise.resolve().then(() => (init_ponyfill(), ponyfill_exports));
    for (const key in stream) {
      if (key === "default") continue;
      Reflect.set(globalThis, key, stream[key]);
    }
    await Promise.resolve().then(() => __toESM(require_Blob()));
    await Promise.resolve().then(() => (init_formdata_min(), formdata_min_exports));
    globalThis.fetch = () => void 0;
    await Promise.resolve().then(() => __toESM(require_umd_polyfill()));
    await Promise.resolve().then(() => __toESM(require_event_target_polyfill()));
    await Promise.resolve().then(() => __toESM(require_polyfill()));
    globalEvent = new EventTarget();
    ...
    ({ Headers: Headers3 } = await Promise.resolve().then(() => (init_lib(), lib_exports)));
    Reflect.set(globalThis, "Headers", Headers3);
    await Promise.resolve().then(() => (init_fetch(), fetch_exports));
    await Promise.resolve().then(() => (init_websocket(), websocket_exports));
    await Promise.resolve().then(() => (init_crypto(), crypto_exports));
    await Promise.resolve().then(() => (init_performance(), performance_exports));
    await Promise.resolve().then(() => (init_wasm(), wasm_exports));
    await Promise.resolve().then(() => (init_storage(), storage_exports));
  }
});

// src/deno/01_errors.ts
var BadResource, Interrupted, NotCapable, NotFound, ConnectionRefused, ConnectionReset, ConnectionAborted, NotConnected, AddrInUse, AddrNotAvailable, BrokenPipe, AlreadyExists, InvalidData, TimedOut, WriteZero, WouldBlock, UnexpectedEof, Http, Busy, PermissionDenied, NotSupported, FilesystemLoop, IsADirectory, NetworkUnreachable, NotADirectory, errors;
var init_errors = __esm({
  "src/deno/01_errors.ts"() {
    ...
    NotCapable = class extends Error {
      constructor(msg) {
        super(msg);
...
var init_package = __esm({
  "package.json"() {
    package_default = {
      name: "cts",
      version: "2.5.6",
      description: "cts - circu.js bootstrap to provide full typescript experience",
      main: "src/main.ts",
      scripts: {
        build: "esbuild src/main.ts --bundle --target=es2024 --format=esm --outfile=dist.js",
        bundle: "cjsc -b cjs -s -e dist.js"
      },
      keywords: [],
      author: "",
      license: "MIT",
...
var fs_exports = {};
__export(fs_exports, {
  asToDenoStat: () => asToDenoStat,
  toDenoStat: () => toDenoStat,
  toString: () => toString
});
function toDenoStat(stat) {
  return {
...
async function mkdirRecursive(fullPath, mode) {
  ...
  for (const part of parts) {
    ...
    try {
      if (!(await asfs2.stat(currentPath)).isDirectory)
        throw -1;
    } catch (error) {
      if (error === -1) {
        throw new Error(`Cannot create directory '${currentPath}': File exists`);
      } else {
        await asfs2.mkdir(currentPath, mode);
      }
    }
  }
}
function mkdirRecursiveSync(fullPath, mode) {
  const normalizedPath = fullPath.replace(/\\/g, "/");
  const parts = normalizedPath.split("/").filter((part) => part !== "" && part !== ".");
  let currentPath = "";
  for (const part of parts) {
    ...
    try {
      if (!fs4.stat(currentPath).isDirectory)
        throw -1;
    } catch (error) {
      if (error === -1) {
        throw new Error(`Cannot create directory '${currentPath}': File exists`);
      } else {
        fs4.mkdir(currentPath, mode);
      }
    }
  }
}
function removeRecursiveSync(targetPath) {
  try {
    const stats = fs4.stat(targetPath);
    if (stats.isDirectory) {
      const items = fs4.readdir(targetPath);
      for (const item of items) {
        removeRecursiveSync(join(targetPath, item));
      }
      fs4.rmdir(targetPath);
    } else {
      fs4.unlink(targetPath);
    }
  } catch (error) {
    throw error;
  }
...
async function removeRecursive(targetPath) {
  try {
    const stats = await asfs2.stat(targetPath);
    if (stats.isDirectory) {
      const dirHandle = await asfs2.readDir(targetPath);
      try {
        for await (const entry2 of dirHandle) {
          const itemPath = join(targetPath, entry2.name);
...
async function denoWriteAnyFile(path2, data, options) {
  let flag = "w";
  if (options?.append) {
    flag = "a";
  ...
  const fhandle = await asfs2.open(toString(path2), flag, options?.mode);
  if (typeof data === "string")
    data = engine7.encodeString(data);
  if (data instanceof Uint8Array) {
    let written = 0;
    while (written < data.length) {
      const n2 = await fhandle.write(data.subarray(written));
      if (n2 === null) {
    ...
    while (true) {
      ...
      if (done) break;
      const n2 = await fhandle.write(
        typeof value === "string" ? engine7.encodeString(value) : value
      );
      if (n2 === null) {
        throw new errors.UnexpectedEof("write");
      }
...
function watchToIterator(path2) {
  let watcher = null;
  ...
  fswatch.watch(path2, (filename, ev) => {
    if (isClosed) return;
    const event = {
...
var fs4, asfs2, engine7, fswatch, os5, toString, dateOrNull;
var init_fs = __esm({
  "src/deno/02_fs.ts"() {
    "use strict";
    init_path();
    ...
    engine7 = import.meta.use("engine");
    fswatch = import.meta.use("fswatch");
    os5 = import.meta.use("os");
    toString = (e2) => e2 instanceof URL ? e2.pathname : e2;
    dateOrNull = (t2) => t2 ? new Date(t2) : null;
    Object.assign(Deno, {
      // @ts-ignore not SharedArrayBuffer
      readFile(path2, opt) {
        return asfs2.readFile(toString(path2));
      },
      readFileSync(path2) {
        return new Uint8Array(fs4.readFile(toString(path2)));
      },
      readTextFile(path2, opt) {
        return Deno.readFile(path2, opt).then((b3) => engine7.decodeString(b3));
      },
      readTextFileSync(path2) {
        return engine7.decodeString(Deno.readFileSync(path2));
      },
      async *readDir(path2) {
        const h2 = await asfs2.readDir(toString(path2));
        while (true) {
          const e2 = await h2.next();
          if (e2.done) break;
          yield {
            name: e2.value.name,
            isDirectory: e2.value.isDirectory,
            isFile: e2.value.isFile,
            isSymlink: e2.value.isSymbolicLink
          };
        }
      },
      *readDirSync(path2) {
        for (const el of fs4.readdir(toString(path2))) {
          const stat = fs4.stat(path2 + "/" + el);
          yield {
            name: el,
            isDirectory: stat.isDirectory,
            isFile: stat.isFile,
      ...
      readLink(path2) {
        return asfs2.readLink(toString(path2));
      },
      readLinkSync(path2) {
        return fs4.readlink(toString(path2));
      },
      link(old, newf) {
        return asfs2.link(toString(old), toString(newf));
      },
      linkSync(old, newf) {
        return fs4.link(toString(old), toString(newf));
      },
      async symlink(old, newf, opt) {
        return asfs2.symlink(
          toString(old),
          toString(newf),
          // @ts-ignore
          opt?.type == "dir" ? asfs2.SymlinkType.DIR : asfs2.SymlinkType.JUNCTION
        );
      },
      symlinkSync(old, newf, opt) {
        return fs4.symlink(toString(old), toString(newf));
      },
      realPath(path2) {
        return asfs2.realPath(toString(path2));
      },
      realPathSync(path2) {
        return fs4.realpath(toString(path2));
      },
      removeSync(path2, opt) {
        const pathStr = toString(path2);
      ...
      async remove(path2, opt) {
        const pathStr = toString(path2);
        const recursive = opt?.recursive ?? false;
        if (!recursive) {
          if ((await asfs2.stat(pathStr)).isDirectory)
            asfs2.rmdir(pathStr);
          else
            asfs2.unlink(pathStr);
          return;
        }
        await removeRecursive(pathStr);
      },
      renameSync(oldPath, newPath) {
        fs4.rename(toString(oldPath), toString(newPath));
      },
      rename(oldPath, newPath) {
        return asfs2.rename(toString(oldPath), toString(newPath));
      },
      copyFile(from, to2) {
        return asfs2.copyFile(toString(from), toString(to2));
      },
      copyFileSync(from, to2) {
        return fs4.copy(toString(from), toString(to2));
      },
      async lstat(path2) {
        return asToDenoStat(await asfs2.lstat(toString(path2)));
      },
      lstatSync(path2) {
        return toDenoStat(fs4.lstat(toString(path2)));
      },
      writeFileSync(path2, data, options) {
        fs4.writeFile(toString(path2), data.buffer);
      },
      writeFile(path2, data, options) {
        return denoWriteAnyFile(path2, data, options);
      },
      writeTextFileSync(path2, data, options) {
        fs4.writeFile(toString(path2), engine7.encodeString(data).buffer);
      },
      writeTextFile(path2, data, options) {
        return denoWriteAnyFile(path2, data, options);
      },
      async truncate(name, len) {
        const file = await asfs2.open(toString(name), "r+");
        file.truncate(len);
        await file.close();
      },
      truncateSync(name, len) {
        fs4.truncate(toString(name), len ?? 0);
      },
      async mkdir(path2, opt) {
        const pathStr = toString(path2);
        const recursive = opt?.recursive ?? false;
        const mode = opt?.mode;
        if (!recursive) {
          return await asfs2.mkdir(pathStr, mode);
        }
      ...
      mkdirSync(path2, opt) {
        ...
        const recursive = opt?.recursive ?? false;
        if (!recursive) {
          return fs4.mkdir(pathStr, opt?.mode);
        }
        mkdirRecursiveSync(pathStr, opt?.mode);
      },
      async makeTempDir(opt) {
        const rand = Math.floor(Math.random() * 1e9).toString(36);
        const tmp = join(opt?.dir ?? os5.tmpdir, opt?.prefix ?? "deno", opt?.suffix ?? rand);
      ...
      chmod(path2, mode) {
        return asfs2.chmod(toString(path2), mode);
      },
      chmodSync(path2, mode) {
        return fs4.chmod(toString(path2), mode);
      },
      chown(path2, uid, gid) {
        const info = os5.userInfo;
        return asfs2.chown(toString(path2), uid ?? info.userId, gid ?? info.groupId);
      },
      chownSync(path2, uid, gid) {
        return fs4.chown(toString(path2), uid ?? os5.userInfo.userId, gid ?? os5.userInfo.groupId);
      },
      async stat(path2) {
        const st2 = await asfs2.stat(toString(path2));
        return asToDenoStat(st2);
      },
      statSync(path2) {
        const st2 = fs4.stat(toString(path2));
        return toDenoStat(st2);
      },
      async makeTempFile(opt) {
        const randomValue = Math.floor(Math.random() * 1e9).toString(36);
        const path2 = join(opt?.dir ?? os5.tmpdir, opt?.prefix ?? "cno", opt?.suffix ?? "cno-") + randomValue;
        await mkdirRecursive(path2, 755);
        return path2;
      },
      makeTempFileSync(opt) {
        const randomValue = Math.floor(Math.random() * 1e9).toString(36);
        const path2 = join(opt?.dir ?? os5.tmpdir, opt?.prefix ?? "cno", opt?.suffix ?? "cno-") + randomValue;
        mkdirRecursiveSync(path2, 755);
        return path2;
      },
      watchFs(path2, options) {
        ...
        paths.forEach((path3) => {
          try {
            const watcher = watchToIterator(path3);
            watchers.set(path3, watcher);
            (async () => {
              try {
            ...
            console.error(`Failed to watch path: ${path3}`, error);
          }
        });
        async function next() {
          if (isClosed) {
        ...
        const iterator = {
          ...
          close: async () => {
            if (isClosed) return;
            isClosed = true;
            for (const [path3, watcher] of watchers) {
              try {
                await watcher.close();
              } catch (error) {
                console.error(`Error closing watcher for path: ${path3}`, error);
              }
            }
            watchers.clear();
            if (resolveNext) {
...
// src/deno/03_fopen.ts
var fopen_exports = {};
__export(fopen_exports, {
  FSFile: () => FSFile,
  optionsToMode: () => optionsToMode
});
function optionsToMode(options) {
  const {
    read = true,
    // Default: readable
    write = false,
...
var init_fopen = __esm({
  "src/deno/03_fopen.ts"() {
    ...
    FSFile = class {
        ...
        this.readable = new ReadableStream({
          pull: async (controller) => {
            try {
              ...
              const n2 = await $handle.read(buf, this.fpointer);
              controller.enqueue(buf.slice(0, n2));
              this.fpointer += n2;
            } catch (e2) {
              controller.error(e2);
            }
          ...
          write: async (chunk, control) => {
            try {
              ...
              while (written < chunk.length) {
                const n2 = await $handle.write(chunk.subarray(written), this.fpointer);
                written += n2;
                this.fpointer += n2;
              }
            } catch (e2) {
      ...
      fpointer = 0;
      async write(data) {
        const n2 = await this.$handle.write(data, this.fpointer);
        this.fpointer += n2;
        return n2;
      }
      writeSync(p2) {
        const fno = this.$handle.fileno();
        const n2 = fs5.write(fno, p2, this.fpointer);
        this.fpointer += n2;
        return n2;
      }
      async read(p2) {
        const n2 = await this.$handle.read(p2, this.fpointer);
        this.fpointer += n2;
        return n2;
      }
      readSync(p2) {
        const fno = this.$handle.fileno();
        const n2 = fs5.read(fno, p2, this.fpointer);
        this.fpointer += n2;
        return n2;
      }
      truncate(len) {
      ...
      statSync() {
        const stat = fs5.stat(this.$handle.path);
        return toDenoStat(stat);
      }
      async seek(offset, whence) {
        const fs7 = (await this.$handle.stat()).size;
        const off = Number(offset);
        if (whence === Deno.SeekMode.Start) {
          this.fpointer = Math.min(off, fs7);
        } else if (whence === Deno.SeekMode.End) {
          this.fpointer = Math.max(fs7 - off, 0);
        }
        return this.fpointer;
      }
      seekSync(offset, whence) {
        const fsize = fs5.lstat(this.$handle.path).size;
        const off = Number(offset);
        if (whence === Deno.SeekMode.Start) {
    ...
    Object.assign(Deno, {
      async open(path2, opt) {
        let flag = "r";
        if (opt) flag = optionsToMode(opt);
        const fh = await asfs3.open(toString(path2), flag, opt?.mode);
        return new FSFile(fh);
      },
      openSync(path2, opt) {
        let flag = "r";
        if (opt) flag = optionsToMode(opt);
        const fno = fs5.open(toString(path2), flag, opt?.mode);
        return new FSFile(asfs3.newStdioFile(toString(path2), fno));
      }
    });
  }
});

// src/deno/04_stdio.ts
var stdio_exports = {};
__export(stdio_exports, {
  Stream: () => Stream
});
var os6, pipe, fs6, syncfs, Stream, stdin, stdout, stderr;
var init_stdio = __esm({
  "src/deno/04_stdio.ts"() {
    ...
    fs6 = import.meta.use("asyncfs");
    syncfs = import.meta.use("fs");
    Stream = class {
      type;
      stream;
      constructor(fd, read = true) {
        const type = os6.guessHandle(fd);
        switch (type) {
          // normal pipe
          case "udp":
          case "pipe":
          ...
          case "tty":
            ...
            break;
          case "file":
            this.stream = new FSFile(fs6.newStdioFile("stdio", fd));
            this.type = "file";
            break;
        }
      }
      ...
      readSync(buf) {
        if (this.type == "file") {
          return this.stream.readSync(buf);
        } else {
          const fno = this.stream.fileno();
        ...
        return new WritableStream({
          write: async (chunk, control) => {
            try {
              let written = 0;
              while (written < chunk.length) {
                const n2 = await this.write(chunk.subarray(written));
                written += n2;
              }
            } catch (e2) {
              control.error(e2);
    ...
    stdin = new Stream(os6.STDIN_FILENO, true);
    stdout = new Stream(os6.STDOUT_FILENO, false);
    stderr = new Stream(os6.STDERR_FILENO, false);
    Object.assign(Deno, {
      stdin: {
        close() {
          stdin.close();
        ...
        read(p2) {
          return stdin.read(p2);
        },
        readSync(p2) {
          return stdin.readSync(p2);
        },
      ...
      stderr: {
        ...
        write(p2) {
          return stderr.write(p2);
        },
        writeSync(p2) {
          return stderr.writeSync(p2);
        },
        isTerminal() {
          return stderr.isTTY;
        },
...
function toConn(sslpipe, pipe3) {
  let handshake = false;
  const hsProm = Promise.withResolvers();
  (async () => {
    const buf = new Uint8Array(2048);
    while (true) {
      const n2 = await pipe3.read(buf);
      if (n2 === null) break;
      sslpipe.feed(buf.subarray(0, n2));
  ...
  return new TlsConn(sslpipe, pipe3, hsProm.promise);
}
var os7, dns2, stream2, ssl2, symbolGetPipe, useWritable, useReadable, Conn, addrinfo2deno, TcpConn, TlsConn, UnixConn, Listener, TcpListener, TlsListener;
var init_net = __esm({
  "src/deno/05_net.ts"() {
    "use strict";
    os7 = import.meta.use("os");
    dns2 = import.meta.use("dns");
    stream2 = import.meta.use("streams");
    ssl2 = import.meta.use("ssl");
    symbolGetPipe = Symbol("Stream.getPipe");
    useWritable = (pipe3) => new WritableStream({
      write: async (chunk, control) => {
        try {
          let written = 0;
          while (written < chunk.length) {
            const n2 = await pipe3.write(chunk.subarray(written));
            written += n2;
          }
        } catch (e2) {
          control.error(e2);
    ...
    useReadable = (pipe3) => new ReadableStream({
      async pull(controller) {
        try {
          ...
          if (n2 === null) {
            ...
            controller.enqueue(buf.subarray(0, n2));
          }
        } catch (e2) {
          controller.error(e2);
        }
    ...
    Conn = class {
      constructor(pipe3, localAddr, remoteAddr) {
        this.pipe = pipe3;
        this.localAddr = localAddr;
        this.remoteAddr = remoteAddr;
        this.$readable = useReadable(pipe3);
        this.$writable = useWritable(pipe3);
      }
      $readable;
      $writable;
      async read(p2) {
        return this.pipe.read(p2);
      }
      write(p2) {
        return this.pipe.write(p2);
      }
      close() {
        this.pipe.close();
      }
    ...
    TcpConn = class extends Conn {
      constructor(pipe3) {
        super(pipe3, addrinfo2deno(pipe3.getsockname()), addrinfo2deno(pipe3.getpeername()));
      }
      setNoDelay(noDelay) {
        this.pipe.setNoDelay(noDelay ?? false);
      }
      setKeepAlive(keepAlive) {
        this.pipe.setKeepAlive(!!keepAlive, 60);
      }
    };
    TlsConn = class {
      constructor($pipe, $rawPipe, $handshake) {
        this.$pipe = $pipe;
        ...
        this.$writable = new WritableStream({
          write: async (chunk, control) => {
            try {
              let written = 0;
              while (written < chunk.length) {
                const n2 = $pipe.write(chunk.subarray(written));
                written += n2;
                await this.output();
              }
            } catch (e2) {
      ...
      async output() {
        ...
        while (written < buf.byteLength) {
          const n2 = await this.$rawPipe.write(buf.subarray(written));
          written += n2;
        }
      }
      get readable() {
      ...
      async read(p2) {
        const buf = this.$pipe.read(p2.byteLength);
        if (buf === null) return null;
        p2.set(new Uint8Array(buf));
        return buf.byteLength;
      }
      async write(p2) {
        const r2 = this.$pipe.write(p2);
        await this.output();
        return r2;
      }
      closeWrite() {
    ...
    UnixConn = class extends Conn {
      constructor(pipe3, path2) {
        super(pipe3, { path: path2, transport: "unix" }, { path: path2, transport: "unix" });
      }
    };
    Listener = class {
      constructor($pipe, $isTCP, $addr) {
        this.$pipe = $pipe;
        this.$isTCP = $isTCP;
        this.$addr = $addr;
      }
      async accept() {
        ...
        return this.$isTCP ? new TcpConn(conn) : new UnixConn(conn, this.$addr.path);
      }
      close() {
        this.$pipe.close();
      }
    ...
    TcpListener = class extends Listener {
      get addr() {
        return this.$addr;
      }
      accept() {
    ...
    TlsListener = class extends Listener {
      constructor(pipe3, addr, sslCtx) {
        super(pipe3, true, addr);
        this.sslCtx = sslCtx;
      }
      async accept() {
        const conn = await this.$pipe.accept();
        const sslpipe = new ssl2.Pipe(this.sslCtx, {
          servername: this.$addr.hostname
        });
        return toConn(sslpipe, conn);
      }
      async *[Symbol.asyncIterator]() {
        while (true) {
          const conn = await this.accept();
    ...
    Object.assign(Deno, {
      networkInterfaces() {
        const intf = os7.networkInterfaces();
        return intf.map((i2) => ({
          ...i2,
          family: i2.address.includes(":") ? "IPv6" : "IPv4",
          scopeid: i2.scopeId ?? null,
          cidr: i2.netmask
        }));
      },
      async resolveDns(query, type, opt) {
        ...
        const info = await dns2.query(query);
        switch (type) {
          case "A":
          case "AAAA":
          case "CNAME":
          case "NS":
          case "PTR":
            return info.filter((i2) => i2.type == dns2[type]).map((i2) => i2.name);
          case "CAA":
            return info.filter((i2) => i2.type == dns2.CAA).map((i2) => ({
              critical: i2.ttl === 0,
              tag: i2.tag,
              value: i2.value
            }));
          case "MX":
            return info.filter((i2) => i2.type == dns2.MX).map((i2) => ({
              exchange: i2.exchange,
              preference: i2.priority
            }));
          case "NAPTR":
            return info.filter((i2) => i2.type == dns2.NAPTR).map((i2) => ({
              flags: i2.flags,
              order: i2.order,
              preference: i2.preference,
              regexp: i2.regexp,
              replacement: i2.replacement,
              services: i2.services
            }));
          case "SOA":
            return info.filter((i2) => i2.type == dns2.SOA).map((i2) => ({
              expire: i2.expire,
              refresh: i2.refresh,
              retry: i2.retry,
              serial: i2.serial,
          ...
          case "SRV":
            return info.filter((i2) => i2.type == dns2.SRV).map((i2) => ({
              port: i2.port,
          ...
          case "TXT":
            return info.filter((i2) => i2.type == dns2.TXT).map((i2) => i2.text);
          default:
      ...
      async connect(options) {
        switch (options.transport) {
          case "tcp":
            ...
            const tcp = new stream2.TCP(host.includes(":") ? os7.AF_INET6 : os7.AF_INET);
            const dnsanswer = await dns2.resolve(host, { family: host.includes(":") ? 6 : 4 });
      ...
      async connectTls(options) {
        ...
        const pipe3 = new stream2.TCP(af4 ? os7.AF_INET : os7.AF_INET6);
        await pipe3.connect({ ip: options.hostname ?? "::", port: options.port });
        const ctx = new ssl2.Context({
          alpn: options.alpnProtocols,
          ca: options.caCerts?.[0],
          verify: !options.unsafelyDisableHostnameVerification,
          mode: "client"
        });
        const sslpipe = new ssl2.Pipe(ctx, {
          servername: options.hostname
        });
        return toConn(sslpipe, pipe3);
      },
      // @ts-ignore
      listen(opt) {
        switch (opt.transport) {
          case "tcp":
            ...
            const tcp = new stream2.TCP(isV4 ? os7.AF_INET : os7.AF_INET6);
            tcp.bind({
              ip: opt.hostname ?? "::",
              port: opt.port
            });
      ...
      async startTls(conn, opt) {
        const pipe3 = conn[symbolGetPipe]?.();
        const sslctx = new ssl2.Context({
          alpn: opt?.alpnProtocols,
          ca: opt?.caCerts?.[0],
          verify: !opt?.unsafelyDisableHostnameVerification,
          mode: "client"
        });
        const sslpipe = new ssl2.Pipe(sslctx, {
...
// src/deno/06_process.ts
var process_exports = {};
var os8, proc, signal, text2, pipe2, RStream, Process, Command;
var init_process = __esm({
  "src/deno/06_process.ts"() {
    ...
    signal = import.meta.use("signal");
    text2 = import.meta.use("text");
    pipe2 = (type) => type == "piped" ? "pipe" : type == "null" ? "ignore" : "inherit";
    RStream = class extends ReadableStream {
      constructor(pipe3) {
        super({
          pull: async (ctrl) => {
            try {
              const buf = new Uint8Array(ctrl.desiredSize ?? 2048);
              const readed = await pipe3.read(buf);
              if (!readed) ctrl.close();
              else ctrl.enqueue(buf.slice(0, readed));
            } catch (e2) {
              ctrl.error(e2);
      ...
      async text() {
        ...
        return new text2.Decoder().decode(buf.buffer);
      }
      async json() {
    ...
    Process = class {
      constructor($proc, $wait) {
        ...
        this.pid = $proc.pid;
        this.status = this.$wait.then((f2) => ({
          code: f2.exit_status,
          success: f2.exit_status === 0,
          signal: f2.term_signal
        }));
      }
      $stdin;
      $stdout;
      ...
      status;
      output() {
        return this.$wait.then(async (f2) => ({
          code: f2.exit_status,
          // @ts-ignore
          signal: f2.term_signal ? signal.signals[f2.term_signal] : null,
          success: f2.exit_status === 0,
    ...
    Command = class {
      ...
      constructor(command, options) {
        const path2 = toString(command);
        this.proc = proc.spawn(path2, options?.args, {
          cwd: options?.cwd ? toString(options.cwd) : void 0,
          env: options?.env,
          stdin: pipe2(options?.stdin) ?? "inherit",
          stdout: pipe2(options?.stdout) ?? "inherit",
          stderr: pipe2(options?.stderr) ?? "inherit",
...
// src/module/http/server.ts
function createServer(handler) {
  return new Server(handler);
}
var streams2, ssl3, crypto5, engine8, http2, timers3, ServerRequest, ServerResponse, ServerSocket, Server;
var init_server = __esm({
  "src/module/http/server.ts"() {
    ...
    ServerRequest = class {
      ...
      _bodyUsed = false;
      _bodyChunks = [];
      constructor(method, url, headers, httpVersion, socket) {
      ...
      async text() {
        const buffer = await this.arrayBuffer();
        return engine8.decodeString(new Uint8Array(buffer));
      }
      /**
       * 读取为 JSON
       */
    ...
    ServerResponse = class {
      ...
      status(code, text3) {
        ...
        this.statusText = text3 || http2.strstatus(code);
        return this;
      }
      /**
       * 设置头部
       ...
       * 发送头部
       */
      async writeHead(statusCode, statusText, headers) {
        if (this.headersSent) {
          throw new Error("Headers already sent");
        }
        ...
        let response = `HTTP/1.1 ${this.statusCode} ${this.statusText}\r
`;
        response += this.headers.toString();
        response += "\r\n";
        await this.socket._write(engine8.encodeString(response));
      ...
      async write(chunk) {
        ...
        if (typeof chunk === "string") {
          data = engine8.encodeString(chunk);
        ...
        if (this.chunkedEncoding) {
          ...
          await this.socket._write(engine8.encodeString(`${chunkSize}\r
`));
          await this.socket._write(data);
          await this.socket._write(engine8.encodeString("\r\n"));
        } else {
          await this.socket._write(data);
        }
      }
      ...
      async end(chunk) {
        ...
        if (this.chunkedEncoding) {
          await this.socket._write(engine8.encodeString("0\r\n\r\n"));
        }
        this.finished = true;
      }
      /**
      ...
      async json(data) {
        ...
        this.setHeader("content-length", String(engine8.encodeString(body).length));
        await this.writeHead();
       ...
       */
      async text(data) {
        const body = engine8.encodeString(data);
      ...
      async upgrade() {
        ...
        const hash = crypto5.sha1(engine8.encodeString(wsKey + magic));
        const accept = crypto5.base64Encode(hash);
      ...
      _getConnection() {
        return {
          ...
          async read(size) {
            ...
            const n2 = await this.socket.read(buf);
            return n2 === null || n2 === 0 ? null : buf.slice(0, n2);
          },
          markActive() {
          },
          markIdle() {
    ...
    Server = class {
       ...
       * 监听端口
       */
      listen(port, hostname = "0.0.0.0", options) {
        if (this.listening) {
        ...
        if (options?.maxRequestsPerConnection !== void 0) {
          this.maxRequestsPerConnection = options.maxRequestsPerConnection;
        }
        this.server = new streams2.TCP();
       ...
       * 监听 HTTPS
       */
      listenTLS(port, hostname = "0.0.0.0", options) {
        if (this.listening) {
          throw new Error("Server already listening");
        }
        this.sslContext = new ssl3.Context({
          mode: "server",
          cert: options.cert,
          key: options.key
        });
          ...
          while (keepAlive && requestCount < this.maxRequestsPerConnection) {
            ...
            if (keepAlive) {
              ...
              const hasNextRequest = await Promise.race([
                ...
                new Promise((resolve) => {
                  timers3.setTimeout(() => resolve(false), this.keepAliveTimeout);
                })
              ]);
              timers3.clearTimeout(timeoutId);
              if (!hasNextRequest) {
                break;
              }
            }
       ...
       * 等待数据可用
       */
      async waitForData(conn, timeout) {
        try {
          const buf = new Uint8Array(1);
          conn.setBlocking(false);
          const n2 = await Promise.race([
            conn.read(buf),
            new Promise((resolve) => timers3.setTimeout(() => resolve(null), timeout))
          ]);
      ...
      async handleRequest(socket) {
        const parser = new http2.Parser(http2.REQUEST);
        let method = "";
        let url = "";
        let httpMajor = 1;
        let httpMinor = 1;
        ...
        parser.onUrl = (ev, buf, off, len) => {
          const view = new Uint8Array(buf).slice(off, off + len);
          url += engine8.decodeString(view);
        };
        parser.onHeaderField = (ev, buf, off, len) => {
          const view = new Uint8Array(buf).slice(off, off + len);
          currentHeaderField = engine8.decodeString(view).toLowerCase();
        };
        parser.onHeaderValue = (ev, buf, off, len) => {
          const view = new Uint8Array(buf).slice(off, off + len);
          const value = engine8.decodeString(view);
          headers.append(currentHeaderField, value);
        };
        parser.onHeadersComplete = () => {
          method = http2.strstatus(parser.state.method) || "GET";
        ...
        try {
          while (!headersComplete) {
            ...
            const n2 = await socket._getConnection().socket.read(buf);
            if (n2 === null || n2 === 0) {
              return null;
            }
            const data = buf.slice(0, n2);
          ...
          const connection = headers.get("connection")?.toLowerCase();
          const keepAlive = connection === "keep-alive" || httpMajor === 1 && httpMinor === 1 && connection !== "close";
          return { keepAlive };
        } catch (err) {
...
function createConnInfo(req, completed) {
...
async function handleResponse(response, req, res) {
...
async function serveTcp(options) {
  const server = createServer(async (req, res) => {
    try {
      const completedResolvers = Promise.withResolvers();
...
async function serveTls(options) {
  ...
  if (typeof options.cert === "string") {
    ...
    const certContent = typeof options.cert === "string" ? options.cert : engine9.decodeString(options.cert);
  ...
  if (typeof options.key === "string") {
    ...
    const keyContent = typeof options.key === "string" ? options.key : engine9.decodeString(options.key);
...
function serve(optionsOrHandler, handler) {
  ...
  if ("path" in options && options.path) {
    return serveUnix(options);
  } else if ("cert" in options && "key" in options) {
    return serveTls(options);
  } else {
...
function calculateWebSocketAccept(key) {
  const magic = "258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
  const hash = crypto6.sha1(engine9.encodeString(key + magic));
  return crypto6.base64Encode(hash);
}
function upgradeWebSocket(request, options) {
  ...
  if (protocols && options?.protocol) {
    const requestedProtocols = protocols.split(",").map((p2) => p2.trim());
  ...
  response[websocketSymbol] = async (req, res) => {
...
var crypto6, engine9, websocketSymbol, HttpServer;
var init_serve = __esm({
  "src/deno/08_serve.ts"() {
    ...
    websocketSymbol = Symbol("server.websocket");
    HttpServer = class {
      server;
      $finished = false;
      addr;
      constructor(server, addr) {
        this.server = server;
        this.addr = addr;
      }
      get finished() {
...
function safeGetEnv(env) {
  try {
    return os9.getenv(env);
  } catch {
  }
  return null;
}
var os9, sys, engine10, signal2, console2, signalMap;
var init_deno = __esm({
  async "src/deno/index.ts"() {
    "use strict";
    init_errors();
    init_package();
    os9 = import.meta.use("os");
    sys = import.meta.use("sys");
    engine10 = import.meta.use("engine");
    signal2 = import.meta.use("signal");
    console2 = import.meta.use("console");
    signalMap = {};
    Object.defineProperty(globalThis, "Deno", {
      value: {
        ...
        pid: os9.pid,
        ppid: os9.ppid,
        args: sys.args.slice(1),
        // remove self
        env: {
          get: safeGetEnv,
          set: os9.setenv,
          has: (key) => safeGetEnv(key) !== null,
          delete: (key) => os9.unsetenv(key),
          toObject() {
            const env = {};
            for (const key of os9.envKeys()) {
              env[key] = os9.getenv(key);
            }
            return env;
          }
        },
        exit: (code) => os9.exit(code == 0 ? Deno.exitCode : code ?? 0),
        exitCode: 0,
        build: {
          arch: os9.uname().machine,
          os: sys.platform,
          standalone: false,
          target: `${os9.uname().machine}-unknown-${sys.platform}`,
          vendor: "cno"
        },
        version: {
          deno: package_default.version,
          // note: this is not real!
          v8: engine10.versions.quickjs,
          typescript: "5.9.0-sucrase"
        },
        cwd: () => os9.cwd,
        chdir: (dir) => os9.chdir(dir),
        mainModule: "",
        // TODO
        execPath: () => sys.exePath,
        noColor: safeGetEnv("NO_COLOR") === "1",
        memoryUsage: () => {
          const memory = os9.memoryUsage();
          return {
        ...
        addSignalListener(sig, handler) {
          const sigint = signal2.signals[sig];
          if (typeof sigint != "number")
            throw new Error(`Invalid signal: ${sig}`);
          if (signalMap[sig]?.has(handler))
            return;
          const ret = signal2.signal(sigint, handler);
          if (!signalMap[sig]) signalMap[sig] = /* @__PURE__ */ new Map();
        ...
        uid() {
          return os9.userInfo.userId;
        },
        gid() {
          return os9.userInfo.groupId;
        }
      },
      writable: false,
      enumerable: true,
    ...
    await Promise.resolve().then(() => (init_fs(), fs_exports));
    await Promise.resolve().then(() => (init_fopen(), fopen_exports));
    await Promise.resolve().then(() => (init_stdio(), stdio_exports));
    await Promise.resolve().then(() => (init_net(), net_exports));
    await Promise.resolve().then(() => (init_process(), process_exports));
    await Promise.resolve().then(() => __toESM(require_http()));
    await Promise.resolve().then(() => (init_serve(), serve_exports));
  }
});
...
var path = {
  ...
  dirname(p2) {
    ...
    return idx === -1 ? "." : p2.substring(0, idx) || "/";
  },
  /**
   * Get base name from path
   */
  basename(p2, ext) {
    let base = p2.substring(p2.lastIndexOf("/") + 1);
   ...
   */
  join(...parts) {
    return parts.filter((p2) => p2).join("/").replace(/\/+/g, "/").replace(/\/\.\//g, "/").replace(/\/\.$/, "");
  },
  /**
...
var ModuleLoader = class {
  ...
  builtinModules = /* @__PURE__ */ new Set([
    "fs",
    "path",
    "os",
    "util",
   ...
   */
  createModule(filename, parent = null) {
    const module = {
      id: filename,
      filename,
      loaded: false,
  ...
  readPackageJson(dirpath) {
    try {
      ...
      this.log(`Failed to read package.json in ${dirpath}:`, e2);
      return null;
    }
  }
  /**
   ...
   */
  resolvePackageExports(pkg, basePath, subpath = ".") {
  ...
  tryResolveAsDirectory(dirpath) {
    ...
    if (pkg) {
      ...
      if (pkg.main) {
        ...
        const resolved = this.tryResolveAsFile(mainPath) || this.tryResolveAsDirectory(mainPath);
        if (resolved) return resolved;
      }
    }
   ...
   */
  resolveNodeModule(request, parentPath) {
    ...
    for (const modulesPath of paths) {
      try {
        ...
        const resolved = this.tryResolveAsFile(modulePath) || this.tryResolveAsDirectory(modulePath);
        if (resolved) return resolved;
      } catch (e2) {
      }
    }
  ...
  resolveModule(request, parentPath) {
    ...
    if (this.builtinModules.has(request)) {
      throw new Error(
        `Cannot require built-in module '${request}'. Use import.meta.use() instead for circu.js modules.`
      );
    }
    if (path.isAbsolute(request)) {
      const resolved2 = this.tryResolveAsFile(request) || this.tryResolveAsDirectory(request);
      if (resolved2) return resolved2;
    }
    if (request.startsWith("./") || request.startsWith("../")) {
      const basePath = path.dirname(parentPath);
      const fullPath = path.resolve(basePath, request);
      const resolved2 = this.tryResolveAsFile(fullPath) || this.tryResolveAsDirectory(fullPath);
      if (resolved2) return resolved2;
    }
...
Module: ${module.filename}`
   ...
   */
  createRequire(parentPath, parentModule) {
    const self2 = this;
    function require2(request) {
      const resolved = self2.resolveModule(request, parentPath);
      if (self2.cache.has(resolved)) {
        const cachedModule = self2.cache.get(resolved);
        self2.log(`Using cached module: ${resolved}`);
        return cachedModule.exports;
      }
      if (self2.loading.has(resolved)) {
        self2.log(`Circular dependency detected: ${resolved}`);
        const circularModule = self2.cache.get(resolved);
        if (circularModule) {
          return circularModule.exports;
        }
      }
      const module = self2.createModule(resolved, parentModule);
      self2.cache.set(resolved, module);
      self2.loading.add(resolved);
      try {
        self2.loadModule(module);
      } catch (error) {
        self2.cache.delete(resolved);
        throw error;
      } finally {
        self2.loading.delete(resolved);
      }
    ...
    require2.resolve = function(request, options) {
      ...
      for (const searchPath of searchPaths) {
        try {
          return self2.resolveModule(request, searchPath);
        } catch (e2) {
        }
      }
      throw new Error(`Cannot resolve module '${request}'`);
    };
    require2.cache = self2.cache;
    require2.main = self2.mainModule;
    require2.extensions = {
      ".js": (module, filename) => self2.loadJavaScriptModule(module),
      ".json": (module, filename) => self2.loadJsonModule(module),
      ".node": (module, filename) => self2.loadNativeModule(module)
    };
    return require2;
  }
  /**
   ...
   */
  installGlobal(mainFilename) {
    const filename = mainFilename || path.join(os.cwd, "index.js");
    const require2 = this.createRequireFunction(filename);
...
function installGlobal(mainFilename, options) {
...
// src/main.ts
installGlobal();
await init_webapi().then(() => webapi_exports);
await init_deno().then(() => deno_exports);
var entry = Deno.args[0];
if (!entry) {
