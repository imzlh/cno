/**
 * node:http2 constants.
 *
 * Node's `http2.constants` table, the `sensitiveHeaders` marker symbol, and the
 * RFC 7540 SETTINGS identifier tables. Leaf module: it imports nothing from this
 * directory, so the identity-sensitive `sensitiveHeaders` symbol is created
 * exactly once.
 */
...
export const SETTINGS_HEADER_TABLE_SIZE = 0x1;
export const SETTINGS_ENABLE_PUSH = 0x2;
export const SETTINGS_MAX_CONCURRENT_STREAMS = 0x3;
export const SETTINGS_INITIAL_WINDOW_SIZE = 0x4;
export const SETTINGS_MAX_FRAME_SIZE = 0x5;
export const SETTINGS_MAX_HEADER_LIST_SIZE = 0x6;
export const SETTINGS_ENABLE_CONNECT_PROTOCOL = 0x8;

export const SETTING_NAME_TO_ID: Record<string, number> = {
...
export const SETTING_ID_TO_NAME: Record<number, string> = {
